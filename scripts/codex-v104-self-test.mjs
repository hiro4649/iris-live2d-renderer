...
const CASES = [
  ...
  ['target_failure_safe_report_written_passes', gates.buildTargetSafeReportFinalizerReport, { targetFailed: true, safeReportWritten: true, reportLocation: 'repo_safe_report_directory' }, 'targetSafeReportFinalizerStatus', 'pass', 'target_safe_report_finalizer'],
  ['target_no_safe_json_treated_as_pass_fails', gates.buildTargetSafeReportFinalizerReport, { noSafeJsonTreatedAsPass: true }, 'targetSafeReportFinalizerStatus', 'fail', 'target_safe_report_finalizer'],
  ['target_empty_safe_json_treated_as_pass_fails', gates.buildTargetSafeReportFinalizerReport, { emptySafeJsonTreatedAsPass: true }, 'targetSafeReportFinalizerStatus', 'fail', 'target_safe_report_finalizer'],
  ['target_no_console_payload_treated_as_pass_fails', gates.buildTargetSafeReportFinalizerReport, { noConsolePayloadTreatedAsPass: true }, 'targetSafeReportFinalizerStatus', 'fail', 'target_safe_report_finalizer'],
  ['target_nonzero_exit_treated_as_pass_fails', gates.buildTargetSafeReportFinalizerReport, { nonzeroExitTreatedAsPass: true }, 'targetSafeReportFinalizerStatus', 'fail', 'target_safe_report_finalizer'],
  ['target_finalizer_skipped_fails', gates.buildTargetSafeReportFinalizerReport, { targetFailed: true, finalizerSkipped: true }, 'targetSafeReportFinalizerStatus', 'fail', 'target_safe_report_finalizer'],
  ['target_failure_without_safe_report_fails', gates.buildTargetSafeReportFinalizerReport, { targetFailed: true, safeReportWritten: false }, 'targetSafeReportFinalizerStatus', 'fail', 'target_safe_report_finalizer'],
