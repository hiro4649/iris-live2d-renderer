...
function buildTargetNoSafeReportFailureFixture(overrides = {}) {
  return {
    ...
    productVerificationStatus: {
      status: 'fail',
      reasonCodes: ['product_verification_required', 'product_verification_evidence_missing', 'remote_product_baseline_missing'],
    ...
    productVerificationEvidenceStatus: {
      status: 'fail',
      reasonCodes: ['product_verification_evidence_missing'],
      compatibilityClass: 'pre_push_remote_evidence_pending',
      effectiveStatus: 'pass_pending_after_push',
      safeSummaryOnly: true,
    },
...
function buildProductTargetEvidencePendingFixture(overrides = {}) {
  return {
    ...
    formalEvidencePrecedenceStatus: {
      status: 'fail',
      reasonCodes: ['formal_evidence_precedence_failed'],
      compatibilityClass: 'pre_push_remote_evidence_pending',
      effectiveStatus: 'pass_pending_after_push',
      safeSummaryOnly: true,
    },
