...
const compatibilityCases = [
  ...
  ['v124_active_authority_tuple_is_current_or_v125_compatible', () => ['v124', 'v125'].includes(buildOrchestrationCapsule().skillContextRouting.activeAuthorityTuple.activeSelfTestSuite)],
];
