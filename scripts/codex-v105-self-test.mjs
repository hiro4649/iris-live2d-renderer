...
const CASES = [
  ...
  ['pr42_product_target_execution_context_can_pass_with_safe_fields', gates.buildPr42ProductTargetExecutionReport, { pendingAfterPush: true, expectedDocsClassified: true }, 'pr42ProductTargetExecutionStatus', 'pass', 'target_safe_report_contract'],
  ['pr42_product_target_timeout_is_not_pass', gates.buildPr42ProductTargetExecutionReport, { targetTimeout: true, pendingAfterPush: true, expectedDocsClassified: true }, 'pr42ProductTargetExecutionStatus', 'fail', 'target_safe_report_contract'],
  ['pr42_product_target_no_safe_report_is_not_pass', gates.buildPr42ProductTargetExecutionReport, { noSafeReport: true, pendingAfterPush: true, expectedDocsClassified: true }, 'pr42ProductTargetExecutionStatus', 'fail', 'target_safe_report_contract'],
  ['pr42_product_target_empty_output_is_not_pass', gates.buildPr42ProductTargetExecutionReport, { emptyOutput: true, pendingAfterPush: true, expectedDocsClassified: true }, 'pr42ProductTargetExecutionStatus', 'fail', 'target_safe_report_contract'],
  ['pr42_product_target_harness_only_policy_does_not_apply', gates.buildPr42ProductTargetExecutionReport, { harnessOnlyExpectedFailureApplied: true, pendingAfterPush: true, expectedDocsClassified: true }, 'pr42ProductTargetExecutionStatus', 'fail', 'target_safe_report_contract'],
  ['pr42_product_target_cannot_be_merge_ready', gates.buildPr42ProductTargetExecutionReport, { mergeReady: true, pendingAfterPush: true, expectedDocsClassified: true }, 'pr42ProductTargetExecutionStatus', 'fail', 'target_safe_report_contract'],
  ['pr42_product_target_preserves_pending_after_push', gates.buildPr42ProductTargetExecutionReport, { expectedDocsClassified: true }, 'pr42ProductTargetExecutionStatus', 'fail', 'target_safe_report_contract'],
  ['pr42_product_target_remote_evidence_pass_fails', gates.buildPr42ProductTargetExecutionReport, { remoteEvidencePass: true, pendingAfterPush: true, expectedDocsClassified: true }, 'pr42ProductTargetExecutionStatus', 'fail', 'target_safe_report_contract'],
  ['pr42_product_target_runtime_readiness_claim_fails', gates.buildPr42ProductTargetExecutionReport, { runtimeReadyClaimed: true, pendingAfterPush: true, expectedDocsClassified: true }, 'pr42ProductTargetExecutionStatus', 'fail', 'target_safe_report_contract'],
  ['pr42_product_target_production_readiness_claim_fails', gates.buildPr42ProductTargetExecutionReport, { productionReadyClaimed: true, pendingAfterPush: true, expectedDocsClassified: true }, 'pr42ProductTargetExecutionStatus', 'fail', 'target_safe_report_contract'],
  ['pr42_product_target_priority1_resolved_fails', gates.buildPr42ProductTargetExecutionReport, { priority1Resolved: true, pendingAfterPush: true, expectedDocsClassified: true }, 'pr42ProductTargetExecutionStatus', 'fail', 'target_safe_report_contract'],
  ['pr42_product_target_motion_dataset_executable_fails', gates.buildPr42ProductTargetExecutionReport, { motionDatasetExecutable: true, pendingAfterPush: true, expectedDocsClassified: true }, 'pr42ProductTargetExecutionStatus', 'fail', 'target_safe_report_contract'],
  ['pr42_product_target_classification_unknown_remains_active', gates.buildPr42ProductTargetExecutionReport, { classificationUnknownSuppressed: true, pendingAfterPush: true, expectedDocsClassified: true }, 'pr42ProductTargetExecutionStatus', 'fail', 'target_safe_report_contract'],
  ['pr42_product_target_expected_docs_classification_required', gates.buildPr42ProductTargetExecutionReport, { pendingAfterPush: true }, 'pr42ProductTargetExecutionStatus', 'fail', 'target_safe_report_contract'],
  ['pr42_product_target_raw_exposure_fails', gates.buildPr42ProductTargetExecutionReport, { rawExposure: true, pendingAfterPush: true, expectedDocsClassified: true }, 'pr42ProductTargetExecutionStatus', 'fail', 'target_safe_report_contract'],
