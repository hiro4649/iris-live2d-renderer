...
function computeEvidenceSummary() {
  return {
    ...
    profileTemplateCompatibilityStatus: report.profileTemplateCompatibilityStatus?.status || 'unknown',
    openaiCodexMethodStatus: report.openaiCodexMethodStatus?.status || 'unknown',
    methodSupportStatus: report.methodSupportStatus?.status || 'unknown',
    productionReadinessStatus: report.productionReadinessStatus?.status || 'unknown',
    evidenceIntegrityStatus: report.evidenceIntegrityStatus?.status || 'unknown',
