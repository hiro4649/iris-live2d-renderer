...
const CASES = [
  ...
  ['pr42_real_path_non_empty_safe_json_pass', gates.buildPr42TargetSafeJsonFinalizationReport, { nonEmptySafeJson: true, pendingAfterPush: true, remoteEvidencePass: false, targetMergeReady: false }, 'pr42TargetSafeJsonFinalizationStatus', 'pass'],
  ['pr42_simulation_and_real_path_share_finalization_pass', gates.buildPr42TargetSafeJsonFinalizationReport, { nonEmptySafeJson: true }, 'pr42TargetSafeJsonFinalizationStatus', 'pass'],
  ['pr42_empty_target_safe_json_fails_fixed_class', gates.buildPr42TargetSafeJsonFinalizationReport, { emptySafeJson: true }, 'pr42TargetSafeJsonFinalizationStatus', 'fail'],
  ['pr42_minimal_failure_without_gate_label_fails', gates.buildPr42TargetSafeJsonFinalizationReport, { nonEmptySafeJson: true, minimalFailureWithoutGateLabel: true }, 'pr42TargetSafeJsonFinalizationStatus', 'fail'],
  ['pr42_missing_product_evidence_artifact_fails', gates.buildPr42TargetSafeJsonFinalizationReport, { nonEmptySafeJson: true, missingArtifact: true }, 'pr42TargetSafeJsonFinalizationStatus', 'fail'],
  ['pr42_malformed_product_evidence_artifact_fails', gates.buildPr42TargetSafeJsonFinalizationReport, { nonEmptySafeJson: true, malformedArtifact: true }, 'pr42TargetSafeJsonFinalizationStatus', 'fail'],
  ['pr42_unclassified_finalization_error_fails', gates.buildPr42TargetSafeJsonFinalizationReport, { nonEmptySafeJson: true, unclassifiedInternalFailure: true }, 'pr42TargetSafeJsonFinalizationStatus', 'fail'],
  ['pr42_finalization_pending_after_push_not_remote_pass', gates.buildPr42TargetSafeJsonFinalizationReport, { nonEmptySafeJson: true, pendingAfterPushAsRemotePass: true }, 'pr42TargetSafeJsonFinalizationStatus', 'fail'],
  ['pr42_finalization_remote_pass_without_same_head_fails', gates.buildPr42TargetSafeJsonFinalizationReport, { nonEmptySafeJson: true, remoteEvidencePassWithoutSameHeadRemotePass: true }, 'pr42TargetSafeJsonFinalizationStatus', 'fail'],
  ['pr42_finalization_target_merge_ready_without_same_head_fails', gates.buildPr42TargetSafeJsonFinalizationReport, { nonEmptySafeJson: true, targetMergeReadyWithoutSameHeadRemotePass: true }, 'pr42TargetSafeJsonFinalizationStatus', 'fail'],
  ['pr42_finalization_runtime_readiness_claim_fails', gates.buildPr42TargetSafeJsonFinalizationReport, { nonEmptySafeJson: true, runtimeReadinessClaimed: true }, 'pr42TargetSafeJsonFinalizationStatus', 'fail'],
  ['pr42_finalization_production_readiness_claim_fails', gates.buildPr42TargetSafeJsonFinalizationReport, { nonEmptySafeJson: true, productionReadinessClaimed: true }, 'pr42TargetSafeJsonFinalizationStatus', 'fail'],
