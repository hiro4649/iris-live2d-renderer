...
Active target harness: v1.3.0 Core / v130 metadata bridge target.
...
v1.3.0 Core installs only the metadata bridge target profile and v111-v129 compatibility bridge. v1.2.9 remains immediate rollback, v1.2.8 remains blocking compatibility, and v1.2.7 remains readable compatibility. It does not create owner authority.
...
HARNESS v1.3.0 Core metadata bridge target: v1.2.9 remains immediate rollback, v1.2.8 remains blocking compatibility, and v1.2.7 remains readable compatibility. No product, runtime, package, lockfile, workflow, deploy, wallet, RPC, or secret scope is authorized by this rollout.
