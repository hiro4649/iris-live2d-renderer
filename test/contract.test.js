...
import {
  ...
  LIVE2D_MOTION_IDENTITY_COMFORT_LONG_CONTINUATION_COMPLETION_REVIEW3_SCHEMA,
  LIVE2D_MOTION_IDENTITY_COMFORT_LONG_CONTINUATION_COMPLETION_REVIEW3_COMPLETED_ITEMS,
  LIVE2D_MOTION_IDENTITY_COMFORT_LONG_CONTINUATION_COMPLETION_REVIEW3_OPEN_BLOCKERS,
  LIVE2D_MOTION_IDENTITY_COMFORT_LONG_CONTINUATION_COMPLETION_REVIEW3_REJECTIONS,
  ...
  LIVE2D_MOTION_IDENTITY_COMFORT_ADMIN_SUMMARY_REDACTION_FIELDS,
  LIVE2D_MOTION_IDENTITY_COMFORT_ADMIN_SUMMARY_REDACTION_REJECTIONS,
  LIVE2D_MOTION_IDENTITY_COMFORT_PUBLIC_ADMIN_SURFACE_ALIGNMENT_SCHEMA,
  LIVE2D_MOTION_IDENTITY_COMFORT_PUBLIC_ADMIN_SURFACE_ALIGNMENT_CHECKS,
  LIVE2D_MOTION_IDENTITY_COMFORT_PUBLIC_ADMIN_SURFACE_ALIGNMENT_REJECTIONS,
  ...
  LIVE2D_MOTION_IDENTITY_COMFORT_OWNER_HANDOFF_STUB_REVIEW_SECTIONS,
  LIVE2D_MOTION_IDENTITY_COMFORT_OWNER_HANDOFF_STUB_BLOCKERS,
  LIVE2D_MOTION_IDENTITY_COMFORT_OWNER_HANDOFF_STUB_REJECTIONS,
  LIVE2D_MOTION_IDENTITY_COMFORT_ROLE_GATE_STUB_SCHEMA,
  LIVE2D_MOTION_IDENTITY_COMFORT_ROLE_GATE_STUB_ROLES,
  LIVE2D_MOTION_IDENTITY_COMFORT_ROLE_GATE_STUB_RULES,
  LIVE2D_MOTION_IDENTITY_COMFORT_ROLE_GATE_STUB_REJECTIONS,
  ...
  LIVE2D_MOTION_IDENTITY_COMFORT_AUDIT_EVENT_STUB_NO_WRITE2_SCHEMA,
  LIVE2D_MOTION_IDENTITY_COMFORT_AUDIT_EVENT_STUB_NO_WRITE2_FIELDS,
  LIVE2D_MOTION_IDENTITY_COMFORT_AUDIT_EVENT_STUB_NO_WRITE2_REJECTIONS,
  LIVE2D_MOTION_IDENTITY_COMFORT_AUDIT_EVENT_UNSAFE_FIELD_GUARD2_SCHEMA,
  LIVE2D_MOTION_IDENTITY_COMFORT_AUDIT_EVENT_UNSAFE_FIELD_GUARD2_LABELS,
  LIVE2D_MOTION_IDENTITY_COMFORT_AUDIT_EVENT_UNSAFE_FIELD_GUARD2_REJECTIONS,
  LIVE2D_MOTION_IDENTITY_COMFORT_AUDIT_UNSAFE_FIELD_GUARD_SCHEMA,
  LIVE2D_MOTION_IDENTITY_COMFORT_AUDIT_UNSAFE_FIELD_GUARD_LABELS,
  LIVE2D_MOTION_IDENTITY_COMFORT_AUDIT_UNSAFE_FIELD_GUARD_REJECTIONS,
  LIVE2D_MOTION_IDENTITY_COMFORT_BLOCKER_GROUPING_STATUS_SURFACE_SCHEMA,
  ...
  LIVE2D_MOTION_IDENTITY_COMFORT_REPEATED_BLOCKER_GROUPING_REJECTIONS,
  ...
  LIVE2D_MOTION_IDENTITY_COMFORT_CONTINUATION_LEDGER_CONSISTENCY_SCHEMA,
  LIVE2D_MOTION_IDENTITY_COMFORT_CONTINUATION_LEDGER_CONSISTENCY_CHECKS,
  LIVE2D_MOTION_IDENTITY_COMFORT_CONTINUATION_LEDGER_CONSISTENCY_REJECTIONS,
  LIVE2D_MOTION_IDENTITY_COMFORT_FINAL_REDACTION_SWEEP2_SCHEMA,
  LIVE2D_MOTION_IDENTITY_COMFORT_FINAL_REDACTION_SWEEP2_SURFACES,
  ...
  LIVE2D_MOTION_IDENTITY_COMFORT_FINAL_NO_SWEETENING_SWEEP2_INPUTS,
  LIVE2D_MOTION_IDENTITY_COMFORT_FINAL_NO_SWEETENING_SWEEP2_REJECTIONS,
...
try {
  ...
  assert.equal(defaultMotionDatasetRowSchemaPreflight.rejected_private_material_fields.includes("access_material"), true);
  ...
  assert.equal(defaultOwnerSubmissionPacket.required_file_shape.includes("access_material_excluded"), true);
  assert.equal(defaultOwnerSubmissionPacket.rejected_submission_field_categories.includes("dataset_row_material"), true);
  assert.equal(defaultOwnerSubmissionPacket.rejected_submission_field_categories.includes("access_material"), true);
  ...
  assertLive2dMotionIdentityComfortLongContinuationCompletionReview3(provisionedRuntimeConfig.live2d_motion_identity_comfort_long_continuation_completion_review3);
  ...
  assertLive2dMotionIdentityComfortAuditEventStubNoWrite2(provisionedRuntimeConfig.live2d_motion_identity_comfort_audit_event_stub_no_write2);
  ...
  assertLive2dMotionIdentityComfortFinalNoSweeteningSweep2(provisionedRuntimeConfig.live2d_motion_identity_comfort_final_no_sweetening_sweep2);
  ...
  assertLive2dMotionIdentityComfortLongContinuationCompletionReview3(provisionedStatus.live2d_motion_identity_comfort_long_continuation_completion_review3);
  ...
  assertLive2dMotionIdentityComfortAuditEventStubNoWrite2(provisionedStatus.live2d_motion_identity_comfort_audit_event_stub_no_write2);
  ...
  assertLive2dMotionIdentityComfortFinalNoSweeteningSweep2(provisionedStatus.live2d_motion_identity_comfort_final_no_sweetening_sweep2);
  ...
  assertLive2dMotionIdentityComfortLongContinuationCompletionReview3(provisionedHealth.live2d_motion_identity_comfort_long_continuation_completion_review3);
  ...
  assertLive2dMotionIdentityComfortAuditEventStubNoWrite2(provisionedHealth.live2d_motion_identity_comfort_audit_event_stub_no_write2);
  ...
  assertLive2dMotionIdentityComfortFinalNoSweeteningSweep2(provisionedHealth.live2d_motion_identity_comfort_final_no_sweetening_sweep2);
  ...
  console.log(JSON.stringify({
    ...
    checked: [
      ...
      "live2d_motion_identity_comfort_long_continuation_completion_review3",
      ...
      "live2d_motion_identity_comfort_audit_event_stub_no_write2",
      ...
      "live2d_motion_identity_comfort_final_no_sweetening_sweep2",
...
function assertRendererReadyEvidenceCollectorUnsafeOutputRejection(summary) {
  ...
  assert.equal(summary.rejectedUnsafeOutputLabels.includes("access_material_rejected"), true);
...
function assertRendererReadyRealEvidenceRequestRejectionFixturePack(summary) {
  ...
  assert.equal(summary.rejectedRealEvidenceRequestCases.includes("access_material_rejected"), true);
  assert.equal(summary.rawValueEchoed, false);
  assert.equal(summary.ownerConfirmationCreated, false);
  assert.equal(summary.ownerConfirmationConfirmed, false);
  assert.equal(summary.runtimeReadinessClaimed, false);
...
function assertLive2dMotionIdentityComfortLongContinuationCompletionReview3(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_COMFORT_LONG_CONTINUATION_COMPLETION_REVIEW3_SCHEMA);
  assert.equal(summary.live2d_motion_identity_comfort_long_continuation_completion_review3_status, "long_continuation_completion_review3_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_long_continuation_completion_review3_only_boundary, true);
  assert.equal(summary.safe_review_summary_only_boundary, true);
  assert.equal(summary.no_renderer_execution_boundary, true);
  assert.equal(summary.no_cue_application_boundary, true);
  assert.equal(summary.no_model_scene_load_boundary, true);
  assert.equal(summary.no_audit_execution_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_identity_comfort_long_continuation_completion_review3_only, true);
  assert.equal(summary.safe_review_summary_only, true);
  for (const flag of [
  ...
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.long_continuation_completion_review3_completed_items, [...LIVE2D_MOTION_IDENTITY_COMFORT_LONG_CONTINUATION_COMPLETION_REVIEW3_COMPLETED_ITEMS]);
  assert.deepEqual(summary.long_continuation_completion_review3_open_blockers, [...LIVE2D_MOTION_IDENTITY_COMFORT_LONG_CONTINUATION_COMPLETION_REVIEW3_OPEN_BLOCKERS]);
  assert.deepEqual(summary.long_continuation_completion_review3_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_LONG_CONTINUATION_COMPLETION_REVIEW3_REJECTIONS]);
  assert.equal(summary.long_continuation_completion_review3_completed_items.includes("final_no_sweetening_sweep2_completed"), true);
  assert.equal(summary.long_continuation_completion_review3_open_blockers.includes("runtime_readiness_not_claimed"), true);
  assert.equal(summary.long_continuation_completion_review3_rejections.includes("review3_executes_audit"), true);
  assert.equal(summary.safe_next_action, "add_motion_identity_comfort_public_admin_surface_alignment");
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
function assertLive2dMotionIdentityComfortAdminSummaryRedaction(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_COMFORT_ADMIN_SUMMARY_REDACTION_SCHEMA);
  assert.equal(summary.live2d_motion_identity_comfort_admin_summary_redaction_status, "admin_summary_redaction_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_admin_summary_redaction_only_boundary, true);
  assert.equal(summary.admin_ordinary_safe_labels_only_boundary, true);
  assert.equal(summary.owner_only_detail_role_gated_boundary, true);
  assert.equal(summary.no_renderer_execution_boundary, true);
  assert.equal(summary.no_cue_application_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_identity_comfort_admin_summary_redaction_only, true);
  assert.equal(summary.admin_ordinary_safe_labels_only, true);
  assert.equal(summary.owner_only_detail_absent_from_admin_ordinary, true);
  assert.equal(summary.admin_summary_reflects_network_locator_material, false);
  assert.equal(summary.admin_summary_reflects_auth_material, false);
  assert.equal(summary.admin_summary_reflects_renderer_material, false);
  assert.equal(summary.admin_summary_reflects_cue_material, false);
  assert.equal(summary.admin_summary_reflects_model_locator_material, false);
  assert.equal(summary.admin_summary_reflects_motion_locator_material, false);
  assert.equal(summary.admin_summary_reflects_owner_only_detail, false);
  assert.equal(summary.admin_summary_reflects_private_relation_signal, false);
  assert.equal(summary.admin_summary_reflects_private_support_signal, false);
  assert.equal(summary.admin_summary_reflects_dependency_note_material, false);
  assert.equal(summary.admin_summary_claims_runtime_ready, false);
  assert.equal(summary.admin_summary_claims_production_ready, false);
  assert.equal(summary.runtime_readiness_claimed, false);
  assert.equal(summary.production_readiness_claimed, false);
  assert.equal(summary.renderer_ready_claimed, false);
  assert.equal(summary.renderer_ready_candidate, false);
  ...
  assert.equal(summary.motion_dataset_executable, false);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.admin_summary_redaction_fields, [...LIVE2D_MOTION_IDENTITY_COMFORT_ADMIN_SUMMARY_REDACTION_FIELDS]);
  assert.deepEqual(summary.admin_summary_redaction_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_ADMIN_SUMMARY_REDACTION_REJECTIONS]);
  for (const blocker of [
  ...
  assert.equal(summary.admin_summary_redaction_fields.includes("admin_ordinary_summary_status"), true);
  assert.equal(summary.admin_summary_redaction_rejections.includes("admin_summary_reflects_owner_only_detail"), true);
  assert.equal(summary.admin_summary_redaction_rejections.includes("admin_summary_claims_runtime_ready"), true);
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
function assertLive2dMotionIdentityComfortPublicAdminSurfaceAlignment(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_COMFORT_PUBLIC_ADMIN_SURFACE_ALIGNMENT_SCHEMA);
  assert.equal(summary.live2d_motion_identity_comfort_public_admin_surface_alignment_status, "public_admin_surface_alignment_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_public_admin_surface_alignment_only_boundary, true);
  assert.equal(summary.public_admin_safe_alignment_only_boundary, true);
  assert.equal(summary.owner_only_detail_role_gated_boundary, true);
  assert.equal(summary.no_renderer_execution_boundary, true);
  assert.equal(summary.no_cue_application_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_identity_comfort_public_admin_surface_alignment_only, true);
  assert.equal(summary.public_admin_safe_alignment_only, true);
  assert.equal(summary.owner_only_detail_absent_from_public, true);
  assert.equal(summary.owner_only_detail_absent_from_admin_ordinary, true);
  for (const flag of [
  ...
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.public_admin_surface_alignment_checks, [...LIVE2D_MOTION_IDENTITY_COMFORT_PUBLIC_ADMIN_SURFACE_ALIGNMENT_CHECKS]);
  assert.deepEqual(summary.public_admin_surface_alignment_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_PUBLIC_ADMIN_SURFACE_ALIGNMENT_REJECTIONS]);
  assert.equal(summary.public_admin_surface_alignment_checks.includes("public_summary_stays_public_safe"), true);
  assert.equal(summary.public_admin_surface_alignment_rejections.includes("alignment_reflects_owner_only_detail"), true);
  assert.equal(summary.safe_next_action, "add_motion_identity_comfort_owner_only_detail_role_gate_stub2");
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
function assertLive2dMotionIdentityComfortOwnerOnlyDetailRoleGateStub2(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_COMFORT_OWNER_ONLY_DETAIL_ROLE_GATE_STUB2_SCHEMA);
  assert.equal(summary.live2d_motion_identity_comfort_owner_only_detail_role_gate_stub2_status, "owner_only_detail_role_gate_stub2_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_owner_only_detail_role_gate_stub2_only_boundary, true);
  assert.equal(summary.owner_only_detail_stub2_definition_only_boundary, true);
  assert.equal(summary.owner_only_detail_not_materialized_boundary, true);
  assert.equal(summary.owner_only_detail_not_public_boundary, true);
  assert.equal(summary.owner_only_detail_not_admin_ordinary_boundary, true);
  assert.equal(summary.owner_only_detail_not_operator_visible_boundary, true);
  assert.equal(summary.no_owner_action_requested_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_identity_comfort_owner_only_detail_role_gate_stub2_only, true);
  assert.equal(summary.owner_only_detail_stub2_present, true);
  for (const flag of [
  ...
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.owner_only_detail_role_gate_stub2_rules, [...LIVE2D_MOTION_IDENTITY_COMFORT_OWNER_ONLY_DETAIL_ROLE_GATE_STUB2_RULES]);
  assert.deepEqual(summary.owner_only_detail_role_gate_stub2_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_OWNER_ONLY_DETAIL_ROLE_GATE_STUB2_REJECTIONS]);
  assert.equal(summary.owner_only_detail_role_gate_stub2_rules.includes("owner_only_detail_stub2_not_public"), true);
  assert.equal(summary.owner_only_detail_role_gate_stub2_rejections.includes("owner_only_detail_stub2_public_visible"), true);
  assert.equal(summary.safe_next_action, "add_motion_identity_comfort_public_role_gate_leak_rejection");
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
function assertLive2dMotionIdentityComfortOperatorHandoffNoAction(summary) {
  ...
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_operator_handoff_no_action_only_boundary, true);
  assert.equal(summary.operator_handoff_plan_only_boundary, true);
  assert.equal(summary.no_operator_action_execution_boundary, true);
  assert.equal(summary.no_renderer_execution_boundary, true);
  assert.equal(summary.no_cue_application_boundary, true);
  assert.equal(summary.no_external_connection_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_identity_comfort_operator_handoff_no_action_only, true);
  assert.equal(summary.operator_handoff_plan_present, true);
  assert.equal(summary.operator_handoff_sent, false);
  assert.equal(summary.operator_action_executed, false);
  assert.equal(summary.renderer_execution_started, false);
  assert.equal(summary.cue_application_started, false);
  assert.equal(summary.external_connection_started, false);
  assert.equal(summary.operator_handoff_claims_runtime_ready, false);
  assert.equal(summary.operator_handoff_claims_production_ready, false);
  assert.equal(summary.operator_handoff_creates_owner_confirmation, false);
  assert.equal(summary.operator_handoff_enables_trusted_loader, false);
  assert.equal(summary.operator_handoff_accepts_actual_data, false);
  assert.equal(summary.runtime_readiness_claimed, false);
  assert.equal(summary.production_readiness_claimed, false);
  assert.equal(summary.renderer_ready_claimed, false);
  assert.equal(summary.renderer_ready_candidate, false);
  ...
  assert.equal(summary.motion_dataset_executable, false);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.operator_handoff_no_action_items, [...LIVE2D_MOTION_IDENTITY_COMFORT_OPERATOR_HANDOFF_NO_ACTION_ITEMS]);
  assert.deepEqual(summary.operator_handoff_no_action_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_OPERATOR_HANDOFF_NO_ACTION_REJECTIONS]);
  for (const blocker of [
  ...
  assert.equal(summary.operator_handoff_no_action_items.includes("operator_handoff_plan_present"), true);
  assert.equal(summary.operator_handoff_no_action_rejections.includes("operator_handoff_sent"), true);
  assert.equal(summary.operator_handoff_no_action_rejections.includes("operator_handoff_claims_runtime_ready"), true);
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
function assertLive2dMotionIdentityComfortOwnerHandoffStub(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_COMFORT_OWNER_HANDOFF_STUB_SCHEMA);
  assert.equal(summary.live2d_motion_identity_comfort_owner_handoff_stub_status, "draft_not_sent");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_owner_handoff_stub_only_boundary, true);
  assert.equal(summary.owner_handoff_draft_only_boundary, true);
  assert.equal(summary.owner_handoff_not_sent_boundary, true);
  assert.equal(summary.no_owner_action_requested_boundary, true);
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_renderer_execution_boundary, true);
  assert.equal(summary.no_cue_application_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_identity_comfort_owner_handoff_stub_only, true);
  assert.equal(summary.owner_handoff_stub_present, true);
  assert.equal(summary.owner_handoff_sent, false);
  assert.equal(summary.owner_action_requested, false);
  assert.equal(summary.owner_action_accepted, false);
  assert.equal(summary.owner_confirmation_created, false);
  assert.equal(summary.owner_confirmation_confirmed, false);
  assert.equal(summary.owner_handoff_accepts_actual_data, false);
  assert.equal(summary.owner_handoff_executes_renderer, false);
  assert.equal(summary.owner_handoff_applies_cue, false);
  assert.equal(summary.owner_handoff_enables_trusted_loader, false);
  assert.equal(summary.owner_handoff_claims_runtime_ready, false);
  assert.equal(summary.owner_handoff_claims_production_ready, false);
  assert.equal(summary.runtime_readiness_claimed, false);
  assert.equal(summary.production_readiness_claimed, false);
  assert.equal(summary.renderer_ready_claimed, false);
  assert.equal(summary.renderer_ready_candidate, false);
  ...
  assert.equal(summary.motion_dataset_executable, false);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.owner_handoff_stub_review_sections, [...LIVE2D_MOTION_IDENTITY_COMFORT_OWNER_HANDOFF_STUB_REVIEW_SECTIONS]);
  assert.deepEqual(summary.owner_handoff_stub_blockers, [...LIVE2D_MOTION_IDENTITY_COMFORT_OWNER_HANDOFF_STUB_BLOCKERS]);
  assert.deepEqual(summary.owner_handoff_stub_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_OWNER_HANDOFF_STUB_REJECTIONS]);
  for (const blocker of [
  ...
  assert.equal(summary.owner_handoff_stub_review_sections.includes("motion_identity_status_review"), true);
  assert.equal(summary.owner_handoff_stub_rejections.includes("owner_handoff_sent"), true);
  assert.equal(summary.owner_handoff_stub_rejections.includes("owner_confirmation_created"), true);
  assert.equal(summary.safe_next_action, "wait_for_explicit_owner_action_and_real_renderer_evidence");
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
...
function assertLive2dMotionIdentityComfortRoleGateStub(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_COMFORT_ROLE_GATE_STUB_SCHEMA);
  assert.equal(summary.live2d_motion_identity_comfort_role_gate_stub_status, "role_gate_stub_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_role_gate_stub_only_boundary, true);
  assert.equal(summary.role_gate_definition_only_boundary, true);
  assert.equal(summary.public_safe_labels_only_boundary, true);
  assert.equal(summary.admin_ordinary_safe_labels_only_boundary, true);
  assert.equal(summary.operator_safe_labels_only_boundary, true);
  assert.equal(summary.owner_only_detail_not_exposed_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_identity_comfort_role_gate_stub_only, true);
  assert.equal(summary.role_gate_stub_present, true);
  assert.equal(summary.public_view_safe_labels_only, true);
  assert.equal(summary.admin_ordinary_safe_labels_only, true);
  assert.equal(summary.operator_view_safe_labels_only, true);
  assert.equal(summary.owner_only_detail_exposed_public, false);
  assert.equal(summary.owner_only_detail_exposed_admin, false);
  assert.equal(summary.role_gate_reflects_network_locator_material, false);
  assert.equal(summary.role_gate_reflects_auth_material, false);
  assert.equal(summary.role_gate_reflects_renderer_material, false);
  assert.equal(summary.role_gate_reflects_cue_material, false);
  assert.equal(summary.role_gate_reflects_private_relation_signal, false);
  assert.equal(summary.role_gate_reflects_private_support_signal, false);
  assert.equal(summary.role_gate_claims_runtime_ready, false);
  assert.equal(summary.role_gate_claims_production_ready, false);
  assert.equal(summary.runtime_readiness_claimed, false);
  assert.equal(summary.production_readiness_claimed, false);
  assert.equal(summary.renderer_ready_claimed, false);
  assert.equal(summary.renderer_ready_candidate, false);
  ...
  assert.equal(summary.motion_dataset_executable, false);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.role_gate_stub_roles, [...LIVE2D_MOTION_IDENTITY_COMFORT_ROLE_GATE_STUB_ROLES]);
  assert.deepEqual(summary.role_gate_stub_rules, [...LIVE2D_MOTION_IDENTITY_COMFORT_ROLE_GATE_STUB_RULES]);
  assert.deepEqual(summary.role_gate_stub_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_ROLE_GATE_STUB_REJECTIONS]);
  for (const blocker of [
  ...
  assert.equal(summary.role_gate_stub_roles.includes("public_safe_summary"), true);
  assert.equal(summary.role_gate_stub_rules.includes("owner_only_detail_not_exposed"), true);
  assert.equal(summary.role_gate_stub_rejections.includes("role_gate_exposes_owner_only_detail_public"), true);
  assert.equal(summary.role_gate_stub_rejections.includes("role_gate_claims_runtime_ready"), true);
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
function assertLive2dMotionIdentityComfortRoleGateRedactionGuard(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_COMFORT_ROLE_GATE_REDACTION_GUARD_SCHEMA);
  assert.equal(summary.live2d_motion_identity_comfort_role_gate_redaction_guard_status, "role_gate_redaction_guard_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_role_gate_redaction_guard_only_boundary, true);
  assert.equal(summary.role_gate_redaction_guard_only_boundary, true);
  assert.equal(summary.public_safe_labels_only_boundary, true);
  assert.equal(summary.admin_ordinary_safe_labels_only_boundary, true);
  assert.equal(summary.operator_safe_labels_only_boundary, true);
  assert.equal(summary.owner_only_detail_not_exposed_boundary, true);
  ...
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_identity_comfort_role_gate_redaction_guard_only, true);
  assert.equal(summary.role_gate_redaction_guard_present, true);
  assert.equal(summary.public_role_gate_redacted, true);
  assert.equal(summary.admin_role_gate_redacted, true);
  assert.equal(summary.operator_role_gate_redacted, true);
  assert.equal(summary.owner_only_detail_exposed_public, false);
  assert.equal(summary.owner_only_detail_exposed_admin, false);
  assert.equal(summary.owner_only_detail_exposed_operator, false);
  assert.equal(summary.role_gate_redaction_reflects_network_locator_material, false);
  assert.equal(summary.role_gate_redaction_reflects_auth_material, false);
  assert.equal(summary.role_gate_redaction_reflects_renderer_material, false);
  assert.equal(summary.role_gate_redaction_reflects_cue_material, false);
  assert.equal(summary.role_gate_redaction_reflects_private_relation_signal, false);
  assert.equal(summary.role_gate_redaction_reflects_private_support_signal, false);
  assert.equal(summary.role_gate_redaction_claims_runtime_ready, false);
  assert.equal(summary.role_gate_redaction_claims_production_ready, false);
  assert.equal(summary.runtime_readiness_claimed, false);
  assert.equal(summary.production_readiness_claimed, false);
  assert.equal(summary.renderer_ready_claimed, false);
  assert.equal(summary.renderer_ready_candidate, false);
  ...
  assert.equal(summary.motion_dataset_executable, false);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.role_gate_redaction_guard_fields, [...LIVE2D_MOTION_IDENTITY_COMFORT_ROLE_GATE_REDACTION_GUARD_FIELDS]);
  assert.deepEqual(summary.role_gate_redaction_guard_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_ROLE_GATE_REDACTION_GUARD_REJECTIONS]);
  for (const blocker of [
  ...
  assert.equal(summary.role_gate_redaction_guard_fields.includes("safe_role_label"), true);
  assert.equal(summary.role_gate_redaction_guard_rejections.includes("role_gate_redaction_exposes_owner_only_detail_public"), true);
  assert.equal(summary.role_gate_redaction_guard_rejections.includes("role_gate_redaction_claims_runtime_ready"), true);
  assert.equal(summary.safe_next_action, "add_motion_identity_comfort_audit_stub_no_write");
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
function assertLive2dMotionIdentityComfortAuditEventStubNoWrite2(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_COMFORT_AUDIT_EVENT_STUB_NO_WRITE2_SCHEMA);
  assert.equal(summary.live2d_motion_identity_comfort_audit_event_stub_no_write2_status, "audit_event_stub_no_write2_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_audit_event_stub_no_write2_only_boundary, true);
  assert.equal(summary.audit_event_stub_no_write2_label_only_boundary, true);
  assert.equal(summary.no_audit_execution_boundary, true);
  assert.equal(summary.no_audit_write_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_identity_comfort_audit_event_stub_no_write2_only, true);
  assert.equal(summary.audit_event_stub_no_write2_present, true);
  for (const flag of [
    "audit_event_write_attempted",
    "audit_entry_created",
    "audit_execution_started",
  ...
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.audit_event_stub_no_write2_fields, [...LIVE2D_MOTION_IDENTITY_COMFORT_AUDIT_EVENT_STUB_NO_WRITE2_FIELDS]);
  assert.deepEqual(summary.audit_event_stub_no_write2_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_AUDIT_EVENT_STUB_NO_WRITE2_REJECTIONS]);
  for (const blocker of [
  ...
  assert.equal(summary.audit_event_stub_no_write2_fields.includes("audit_event_write_not_attempted"), true);
  assert.equal(summary.audit_event_stub_no_write2_rejections.includes("audit_event_stub2_writes_audit_event"), true);
  assert.equal(summary.audit_event_stub_no_write2_rejections.includes("audit_event_stub2_resolves_priority1"), true);
  assert.equal(summary.safe_next_action, "add_motion_identity_comfort_audit_event_unsafe_field_guard2");
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
function assertLive2dMotionIdentityComfortAuditEventUnsafeFieldGuard2(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_COMFORT_AUDIT_EVENT_UNSAFE_FIELD_GUARD2_SCHEMA);
  assert.equal(summary.live2d_motion_identity_comfort_audit_event_unsafe_field_guard2_status, "audit_event_unsafe_field_guard2_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_audit_event_unsafe_field_guard2_only_boundary, true);
  assert.equal(summary.audit_event_unsafe_field_guard2_label_only_boundary, true);
  assert.equal(summary.unsafe_material_rejection_boundary, true);
  assert.equal(summary.no_audit_execution_boundary, true);
  assert.equal(summary.no_audit_write_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_identity_comfort_audit_event_unsafe_field_guard2_only, true);
  assert.equal(summary.audit_event_unsafe_field_guard2_present, true);
  for (const flag of [
  ...
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.audit_event_unsafe_field_guard2_labels, [...LIVE2D_MOTION_IDENTITY_COMFORT_AUDIT_EVENT_UNSAFE_FIELD_GUARD2_LABELS]);
  assert.deepEqual(summary.audit_event_unsafe_field_guard2_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_AUDIT_EVENT_UNSAFE_FIELD_GUARD2_REJECTIONS]);
  assert.equal(summary.audit_event_unsafe_field_guard2_labels.includes("renderer_material_absent"), true);
  assert.equal(summary.audit_event_unsafe_field_guard2_labels.includes("operator_instruction_material_absent"), true);
  assert.equal(summary.audit_event_unsafe_field_guard2_rejections.includes("audit_event_guard2_renderer_material_present"), true);
  assert.equal(summary.audit_event_unsafe_field_guard2_rejections.includes("audit_event_guard2_audit_body_material_present"), true);
  for (const blocker of [
  ...
  assert.equal(summary.safe_next_action, "add_motion_identity_comfort_blocker_grouping_status_surface");
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
function assertLive2dMotionIdentityComfortAuditUnsafeFieldGuard(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_COMFORT_AUDIT_UNSAFE_FIELD_GUARD_SCHEMA);
  assert.equal(summary.live2d_motion_identity_comfort_audit_unsafe_field_guard_status, "audit_unsafe_field_guard_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_audit_unsafe_field_guard_only_boundary, true);
  assert.equal(summary.audit_unsafe_field_guard_only_boundary, true);
  assert.equal(summary.safe_audit_labels_only_boundary, true);
  assert.equal(summary.no_source_material_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_identity_comfort_audit_unsafe_field_guard_only, true);
  assert.equal(summary.audit_unsafe_field_guard_present, true);
  for (const flag of [
  ...
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.audit_unsafe_field_guard_labels, [...LIVE2D_MOTION_IDENTITY_COMFORT_AUDIT_UNSAFE_FIELD_GUARD_LABELS]);
  assert.deepEqual(summary.audit_unsafe_field_guard_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_AUDIT_UNSAFE_FIELD_GUARD_REJECTIONS]);
  assert.equal(summary.blocked_reasons.includes("motion_identity_comfort_audit_unsafe_field_guard_only"), true);
  assert.equal(summary.blocked_reasons.includes("source_material_absent"), true);
  assert.equal(summary.safe_next_action, "add_motion_identity_comfort_repeated_blocker_grouping");
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
function assertLive2dMotionIdentityComfortBlockerGroupingStatusSurface(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_COMFORT_BLOCKER_GROUPING_STATUS_SURFACE_SCHEMA);
  assert.equal(summary.live2d_motion_identity_comfort_blocker_grouping_status_surface_status, "blocker_grouping_status_surface_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_blocker_grouping_status_surface_only_boundary, true);
  assert.equal(summary.blocker_grouping_status_surface_label_only_boundary, true);
  assert.equal(summary.no_blocker_resolution_boundary, true);
  assert.equal(summary.no_work_permission_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_identity_comfort_blocker_grouping_status_surface_only, true);
  assert.equal(summary.blocker_grouping_status_surface_present, true);
  for (const flag of [
  ...
  assert.deepEqual(summary.blocker_grouping_status_surface_groups, [...LIVE2D_MOTION_IDENTITY_COMFORT_BLOCKER_GROUPING_STATUS_SURFACE_GROUPS]);
  assert.deepEqual(summary.blocker_grouping_status_surface_labels, [...LIVE2D_MOTION_IDENTITY_COMFORT_BLOCKER_GROUPING_STATUS_SURFACE_LABELS]);
  assert.deepEqual(summary.blocker_grouping_status_surface_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_BLOCKER_GROUPING_STATUS_SURFACE_REJECTIONS]);
  assert.equal(summary.blocker_grouping_status_surface_groups.includes("readiness_blockers"), true);
  assert.equal(summary.blocker_grouping_status_surface_labels.includes("priority1_blocked"), true);
  assert.equal(summary.blocker_grouping_status_surface_labels.includes("checked_row_count_zero"), true);
  assert.equal(summary.blocker_grouping_status_surface_rejections.includes("blocker_grouping_status_surface_claims_resolution"), true);
  for (const blocker of [
  ...
  assert.equal(summary.safe_next_action, "add_motion_identity_comfort_blocker_grouping_contract2");
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
function assertLive2dMotionIdentityComfortRepeatedBlockerGrouping(summary) {
  ...
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_repeated_blocker_grouping_only_boundary, true);
  assert.equal(summary.blocker_grouping_label_only_boundary, true);
  assert.equal(summary.no_blocker_resolution_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_identity_comfort_repeated_blocker_grouping_only, true);
  assert.equal(summary.repeated_blocker_grouping_present, true);
  for (const flag of [
  ...
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.repeated_blocker_groups, [...LIVE2D_MOTION_IDENTITY_COMFORT_REPEATED_BLOCKER_GROUPS]);
  assert.deepEqual(summary.repeated_blocker_labels, [...LIVE2D_MOTION_IDENTITY_COMFORT_REPEATED_BLOCKER_LABELS]);
  assert.deepEqual(summary.repeated_blocker_grouping_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_REPEATED_BLOCKER_GROUPING_REJECTIONS]);
  assert.equal(summary.repeated_blocker_groups.includes("readiness_blockers"), true);
  assert.equal(summary.repeated_blocker_labels.includes("priority1_blocked"), true);
  assert.equal(summary.repeated_blocker_grouping_rejections.includes("blocker_grouping_claims_resolution"), true);
  assert.equal(summary.blocked_reasons.includes("motion_identity_comfort_repeated_blocker_grouping_only"), true);
  assert.equal(summary.blocked_reasons.includes("checked_row_count_zero"), true);
  assert.equal(summary.safe_next_action, "add_motion_identity_comfort_repeated_blocker_grouping_contract");
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
function assertLive2dMotionIdentityComfortRepeatedBlockerGroupingContract(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_COMFORT_REPEATED_BLOCKER_GROUPING_CONTRACT_SCHEMA);
  assert.equal(summary.live2d_motion_identity_comfort_repeated_blocker_grouping_contract_status, "repeated_blocker_grouping_contract_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_repeated_blocker_grouping_contract_only_boundary, true);
  assert.equal(summary.blocker_grouping_contract_only_boundary, true);
  assert.equal(summary.blocker_grouping_label_only_boundary, true);
  assert.equal(summary.no_blocker_resolution_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_identity_comfort_repeated_blocker_grouping_contract_only, true);
  assert.equal(summary.repeated_blocker_grouping_contract_present, true);
  for (const flag of [
  ...
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.repeated_blocker_grouping_contract_rules, [...LIVE2D_MOTION_IDENTITY_COMFORT_REPEATED_BLOCKER_GROUPING_CONTRACT_RULES]);
  assert.deepEqual(summary.repeated_blocker_grouping_contract_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_REPEATED_BLOCKER_GROUPING_CONTRACT_REJECTIONS]);
  assert.equal(summary.repeated_blocker_grouping_contract_rules.includes("grouping_preserves_priority1_blocked"), true);
  assert.equal(summary.repeated_blocker_grouping_contract_rejections.includes("grouping_contract_claims_resolution"), true);
  assert.equal(summary.safe_next_action, "add_motion_identity_comfort_continuation_ledger");
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
function assertLive2dMotionIdentityComfortContinuationLedger(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_COMFORT_CONTINUATION_LEDGER_SCHEMA);
  assert.equal(summary.live2d_motion_identity_comfort_continuation_ledger_status, "continuation_ledger_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_continuation_ledger_only_boundary, true);
  assert.equal(summary.continuation_ledger_label_only_boundary, true);
  assert.equal(summary.no_owner_action_boundary, true);
  assert.equal(summary.no_blocker_resolution_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_identity_comfort_continuation_ledger_only, true);
  assert.equal(summary.continuation_ledger_present, true);
  for (const flag of [
  ...
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.continuation_ledger_entries, [...LIVE2D_MOTION_IDENTITY_COMFORT_CONTINUATION_LEDGER_ENTRIES]);
  assert.deepEqual(summary.continuation_ledger_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_CONTINUATION_LEDGER_REJECTIONS]);
  assert.equal(summary.continuation_ledger_entries.includes("repeated_blocker_grouping_contract_completed"), true);
  assert.equal(summary.continuation_ledger_rejections.includes("continuation_ledger_starts_actual_data"), true);
  assert.equal(summary.safe_next_action, "add_motion_identity_comfort_continuation_ledger_consistency");
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
function assertLive2dMotionIdentityComfortContinuationLedgerConsistency(summary) {
  ...
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_continuation_ledger_consistency_only_boundary, true);
  assert.equal(summary.continuation_ledger_consistency_label_only_boundary, true);
  assert.equal(summary.no_owner_action_boundary, true);
  assert.equal(summary.no_blocker_resolution_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_identity_comfort_continuation_ledger_consistency_only, true);
  assert.equal(summary.continuation_ledger_consistency_present, true);
  assert.equal(summary.ledger_entries_match_completed_surfaces, true);
  for (const flag of [
  ...
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.continuation_ledger_consistency_checks, [...LIVE2D_MOTION_IDENTITY_COMFORT_CONTINUATION_LEDGER_CONSISTENCY_CHECKS]);
  assert.deepEqual(summary.continuation_ledger_consistency_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_CONTINUATION_LEDGER_CONSISTENCY_REJECTIONS]);
  assert.equal(summary.continuation_ledger_consistency_checks.includes("ledger_entries_match_completed_surfaces"), true);
  assert.equal(summary.continuation_ledger_consistency_rejections.includes("ledger_consistency_claims_owner_action"), true);
  assert.equal(summary.safe_next_action, "add_motion_identity_comfort_final_redaction_sweep2");
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
function assertLive2dMotionIdentityComfortFinalRedactionSweep2(summary) {
  ...
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_final_redaction_sweep2_only_boundary, true);
  assert.equal(summary.safe_summary_only_boundary, true);
  assert.equal(summary.no_redaction_scan_execution_boundary, true);
  assert.equal(summary.no_motion_execution_boundary, true);
  assert.equal(summary.no_renderer_probe_boundary, true);
  ...
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_identity_comfort_final_redaction_sweep2_only, true);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.final_redaction_sweep2_present, true);
  assert.equal(summary.final_redaction_sweep2_executes_scan, false);
  for (const flag of [
    "final_redaction_sweep2_network_locator_material_exposed",
    "final_redaction_sweep2_auth_material_exposed",
    "final_redaction_sweep2_renderer_material_exposed",
    "final_redaction_sweep2_cue_material_exposed",
    "final_redaction_sweep2_model_locator_material_exposed",
    "final_redaction_sweep2_motion_locator_material_exposed",
    "final_redaction_sweep2_runtime_material_exposed",
    "final_redaction_sweep2_operator_note_material_exposed",
    "runtime_readiness_claimed",
    "production_readiness_claimed",
    "renderer_ready_claimed",
    "renderer_ready_candidate",
  ...
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.final_redaction_sweep2_surfaces, [...LIVE2D_MOTION_IDENTITY_COMFORT_FINAL_REDACTION_SWEEP2_SURFACES]);
  assert.deepEqual(summary.final_redaction_sweep2_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_FINAL_REDACTION_SWEEP2_REJECTIONS]);
  assert.equal(summary.final_redaction_sweep2_surfaces.includes("continuation_ledger_consistency"), true);
  assert.equal(summary.final_redaction_sweep2_rejections.includes("final_redaction_sweep2_executes_scan"), true);
  assert.equal(summary.safe_next_action, "add_motion_identity_comfort_final_no_sweetening_sweep2");
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
function assertLive2dMotionIdentityComfortFinalNoSweeteningSweep2(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_COMFORT_FINAL_NO_SWEETENING_SWEEP2_SCHEMA);
  assert.equal(summary.live2d_motion_identity_comfort_final_no_sweetening_sweep2_status, "final_no_sweetening_sweep2_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_final_no_sweetening_sweep2_only_boundary, true);
  assert.equal(summary.no_readiness_sweetening_boundary, true);
  assert.equal(summary.no_motion_execution_boundary, true);
  assert.equal(summary.no_runtime_motion_executable_boundary, true);
  assert.equal(summary.no_owner_confirmation_boundary, true);
  ...
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.no_trusted_loader_enablement_boundary, true);
  assert.equal(summary.motion_identity_comfort_final_no_sweetening_sweep2_only, true);
  for (const flag of [
    "final_redaction_sweep2_is_runtime_readiness",
    "continuation_ledger_is_runtime_readiness",
    "role_gate_is_owner_action",
    "audit_stub_executes_audit",
    "public_safe_summary_is_runtime_ready",
    "completion_review_is_production_ready",
    "experimental_labels_executable",
    "runtime_motion_executable",
    "strong_motion_ready",
    "runtime_readiness_claimed",
    "production_readiness_claimed",
    "renderer_ready_claimed",
  ...
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.final_no_sweetening_sweep2_inputs, [...LIVE2D_MOTION_IDENTITY_COMFORT_FINAL_NO_SWEETENING_SWEEP2_INPUTS]);
  assert.deepEqual(summary.final_no_sweetening_sweep2_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_FINAL_NO_SWEETENING_SWEEP2_REJECTIONS]);
  assert.equal(summary.final_no_sweetening_sweep2_inputs.includes("final_redaction_sweep2"), true);
  assert.equal(summary.final_no_sweetening_sweep2_rejections.includes("priority1_marked_resolved"), true);
  assert.equal(summary.safe_next_action, "add_motion_identity_comfort_long_continuation_completion_review3");
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
{
  const summary = createLive2dMotionIdentityComfortLongContinuationCompletionReview3({
    review3_executes_renderer: true,
    review3_applies_cue: true,
    review3_loads_model: true,
    review3_loads_scene: true,
    review3_executes_audit: true,
    review3_claims_runtime_ready: true,
    review3_claims_production_ready: true,
    renderer_ready_claimed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    owner_confirmation_confirmed: true,
  ...
  assertLive2dMotionIdentityComfortLongContinuationCompletionReview3(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_comfort_long_continuation_completion_review3_rejected_state_promotion"), true);
}
...
{
  const summary = createLive2dMotionIdentityComfortAdminSummaryRedaction({
    admin_summary_reflects_network_locator_material: true,
    admin_summary_reflects_auth_material: true,
    admin_summary_reflects_renderer_material: true,
    admin_summary_reflects_cue_material: true,
    admin_summary_reflects_model_locator_material: true,
    admin_summary_reflects_motion_locator_material: true,
    admin_summary_reflects_owner_only_detail: true,
    admin_summary_reflects_private_relation_signal: true,
    admin_summary_reflects_private_support_signal: true,
    admin_summary_reflects_dependency_note_material: true,
    admin_summary_claims_runtime_ready: true,
    admin_summary_claims_production_ready: true,
    renderer_ready_claimed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    owner_confirmation_confirmed: true,
  ...
  assertLive2dMotionIdentityComfortAdminSummaryRedaction(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_comfort_admin_summary_redaction_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityComfortPublicAdminSurfaceAlignment({
    alignment_reflects_network_locator_material: true,
    alignment_reflects_auth_material: true,
    alignment_reflects_renderer_material: true,
    alignment_reflects_cue_material: true,
    alignment_reflects_model_locator_material: true,
    alignment_reflects_motion_locator_material: true,
    alignment_reflects_owner_only_detail: true,
    alignment_reflects_private_relation_signal: true,
    alignment_reflects_private_support_signal: true,
    alignment_claims_runtime_ready: true,
    alignment_claims_production_ready: true,
    renderer_ready_claimed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    owner_confirmation_confirmed: true,
  ...
  assertLive2dMotionIdentityComfortPublicAdminSurfaceAlignment(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_comfort_public_admin_surface_alignment_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityComfortOwnerOnlyDetailRoleGateStub2({
    owner_only_detail_stub2_materialized: true,
    owner_only_detail_stub2_public_visible: true,
    owner_only_detail_stub2_admin_ordinary_visible: true,
    owner_only_detail_stub2_operator_visible: true,
    owner_only_detail_stub2_requests_owner_action: true,
    owner_only_detail_stub2_creates_owner_confirmation: true,
    owner_only_detail_stub2_accepts_actual_data: true,
    owner_only_detail_stub2_claims_runtime_ready: true,
    owner_only_detail_stub2_claims_production_ready: true,
    renderer_ready_claimed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    owner_confirmation_confirmed: true,
...
{
  const summary = createLive2dMotionIdentityComfortOperatorHandoffNoAction({
    operator_handoff_sent: true,
    operator_action_executed: true,
    renderer_execution_started: true,
    cue_application_started: true,
    external_connection_started: true,
    operator_handoff_claims_runtime_ready: true,
    operator_handoff_claims_production_ready: true,
    operator_handoff_creates_owner_confirmation: true,
    operator_handoff_enables_trusted_loader: true,
    operator_handoff_accepts_actual_data: true,
    renderer_ready_claimed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    owner_confirmation_confirmed: true,
  ...
  assertLive2dMotionIdentityComfortOperatorHandoffNoAction(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_comfort_operator_handoff_no_action_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityComfortOwnerHandoffStub({
    owner_handoff_sent: true,
    owner_action_requested: true,
    owner_action_accepted: true,
    owner_confirmation_created: true,
    owner_confirmation_confirmed: true,
    owner_handoff_accepts_actual_data: true,
    owner_handoff_executes_renderer: true,
    owner_handoff_applies_cue: true,
    owner_handoff_enables_trusted_loader: true,
    owner_handoff_claims_runtime_ready: true,
    owner_handoff_claims_production_ready: true,
    renderer_ready_claimed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    motion_dataset_executable: true,
  ...
  assertLive2dMotionIdentityComfortOwnerHandoffStub(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_comfort_owner_handoff_stub_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityComfortRoleGateStub({
    owner_only_detail_exposed_public: true,
    owner_only_detail_exposed_admin: true,
    role_gate_reflects_network_locator_material: true,
    role_gate_reflects_auth_material: true,
    role_gate_reflects_renderer_material: true,
    role_gate_reflects_cue_material: true,
    role_gate_reflects_private_relation_signal: true,
    role_gate_reflects_private_support_signal: true,
    role_gate_claims_runtime_ready: true,
    role_gate_claims_production_ready: true,
    renderer_ready_claimed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    owner_confirmation_confirmed: true,
  ...
  assertLive2dMotionIdentityComfortRoleGateStub(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_comfort_role_gate_stub_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityComfortRoleGateRedactionGuard({
    owner_only_detail_exposed_public: true,
    owner_only_detail_exposed_admin: true,
    owner_only_detail_exposed_operator: true,
    role_gate_redaction_reflects_network_locator_material: true,
    role_gate_redaction_reflects_auth_material: true,
    role_gate_redaction_reflects_renderer_material: true,
    role_gate_redaction_reflects_cue_material: true,
    role_gate_redaction_reflects_private_relation_signal: true,
    role_gate_redaction_reflects_private_support_signal: true,
    role_gate_redaction_claims_runtime_ready: true,
    role_gate_redaction_claims_production_ready: true,
    renderer_ready_claimed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    owner_confirmation_confirmed: true,
...
{
  const summary = createLive2dMotionIdentityComfortAuditEventStubNoWrite2({
    audit_event_write_attempted: true,
    audit_entry_created: true,
    audit_execution_started: true,
    audit_event_stub2_writes_audit_event: true,
    audit_event_stub2_creates_audit_entry: true,
    audit_event_stub2_executes_audit: true,
    audit_event_stub2_accepts_actual_data: true,
    audit_event_stub2_exposes_owner_only_detail: true,
    audit_event_stub2_claims_runtime_ready: true,
    audit_event_stub2_claims_production_ready: true,
    audit_event_stub2_resolves_priority1: true,
    renderer_ready_claimed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    owner_confirmation_confirmed: true,
  ...
  assertLive2dMotionIdentityComfortAuditEventStubNoWrite2(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_comfort_audit_event_stub_no_write2_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityComfortAuditEventUnsafeFieldGuard2({
    audit_event_guard2_renderer_material_present: true,
    audit_event_guard2_cue_material_present: true,
    audit_event_guard2_model_locator_material_present: true,
    audit_event_guard2_motion_locator_material_present: true,
    audit_event_guard2_network_locator_material_present: true,
    audit_event_guard2_access_material_present: true,
    audit_event_guard2_private_relation_signal_present: true,
    audit_event_guard2_private_support_signal_present: true,
    audit_event_guard2_operator_instruction_material_present: true,
    audit_event_guard2_audit_body_material_present: true,
    audit_event_guard2_claims_runtime_ready: true,
    audit_event_guard2_claims_production_ready: true,
    audit_event_write_attempted: true,
    audit_entry_created: true,
    audit_execution_started: true,
    renderer_ready_claimed: true,
  ...
  assertLive2dMotionIdentityComfortAuditEventUnsafeFieldGuard2(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_comfort_audit_event_unsafe_field_guard2_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityComfortAuditUnsafeFieldGuard({
    audit_guard_unsafe_source_material_present: true,
    audit_guard_network_locator_material_present: true,
    audit_guard_access_material_present: true,
    audit_guard_owner_private_detail_present: true,
    audit_guard_renderer_material_present: true,
    audit_guard_cue_material_present: true,
    audit_guard_file_content_present: true,
    audit_guard_identity_value_present: true,
    audit_guard_claims_runtime_ready: true,
    audit_guard_claims_production_ready: true,
    renderer_ready_claimed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    owner_confirmation_confirmed: true,
  ...
  assertLive2dMotionIdentityComfortAuditUnsafeFieldGuard(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_comfort_audit_unsafe_field_guard_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityComfortBlockerGroupingStatusSurface({
    blocker_grouping_status_surface_claims_resolution: true,
    blocker_grouping_status_surface_authorizes_work: true,
    blocker_grouping_status_surface_sets_checked_count: true,
    blocker_grouping_status_surface_makes_motion_executable: true,
    blocker_grouping_status_surface_enables_trusted_loader: true,
    blocker_grouping_status_surface_creates_owner_confirmation: true,
    blocker_grouping_status_surface_claims_runtime_ready: true,
    blocker_grouping_status_surface_claims_production_ready: true,
    renderer_ready_claimed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    owner_confirmation_confirmed: true,
...
{
  const summary = createLive2dMotionIdentityComfortRepeatedBlockerGrouping({
    blocker_grouping_claims_resolution: true,
    blocker_grouping_changes_priority1: true,
    blocker_grouping_sets_checked_count: true,
    blocker_grouping_makes_motion_executable: true,
    blocker_grouping_enables_trusted_loader: true,
    blocker_grouping_creates_owner_confirmation: true,
    blocker_grouping_claims_runtime_ready: true,
    blocker_grouping_claims_production_ready: true,
    renderer_ready_claimed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    owner_confirmation_confirmed: true,
  ...
  assertLive2dMotionIdentityComfortRepeatedBlockerGrouping(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_comfort_repeated_blocker_grouping_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityComfortRepeatedBlockerGroupingContract({
    grouping_contract_claims_resolution: true,
    grouping_contract_omits_priority1_blocked: true,
    grouping_contract_omits_checked_row_count_zero: true,
    grouping_contract_omits_motion_dataset_non_executable: true,
    grouping_contract_enables_trusted_loader: true,
    grouping_contract_creates_owner_confirmation: true,
    grouping_contract_claims_runtime_ready: true,
    grouping_contract_claims_production_ready: true,
    renderer_ready_claimed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    owner_confirmation_confirmed: true,
  ...
  assertLive2dMotionIdentityComfortRepeatedBlockerGroupingContract(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_comfort_repeated_blocker_grouping_contract_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityComfortContinuationLedger({
    continuation_ledger_claims_owner_action: true,
    continuation_ledger_claims_blocker_resolution: true,
    continuation_ledger_claims_runtime_ready: true,
    continuation_ledger_claims_production_ready: true,
    continuation_ledger_changes_checked_count: true,
    continuation_ledger_makes_motion_executable: true,
    continuation_ledger_enables_trusted_loader: true,
    continuation_ledger_starts_actual_data: true,
    renderer_ready_claimed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    owner_confirmation_confirmed: true,
...
{
  const summary = createLive2dMotionIdentityComfortContinuationLedgerConsistency({
    ledger_consistency_claims_owner_action: true,
    ledger_consistency_claims_blocker_resolution: true,
    ledger_consistency_claims_runtime_ready: true,
    ledger_consistency_claims_production_ready: true,
    renderer_ready_claimed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    owner_confirmation_confirmed: true,
  ...
  assertLive2dMotionIdentityComfortContinuationLedgerConsistency(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_comfort_continuation_ledger_consistency_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityComfortFinalRedactionSweep2({
    final_redaction_sweep2_executes_scan: true,
    final_redaction_sweep2_network_locator_material_exposed: true,
    final_redaction_sweep2_auth_material_exposed: true,
    final_redaction_sweep2_renderer_material_exposed: true,
    final_redaction_sweep2_cue_material_exposed: true,
    final_redaction_sweep2_model_locator_material_exposed: true,
    final_redaction_sweep2_motion_locator_material_exposed: true,
    final_redaction_sweep2_runtime_material_exposed: true,
    final_redaction_sweep2_operator_note_material_exposed: true,
    renderer_ready_claimed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    owner_confirmation_confirmed: true,
  ...
  assertLive2dMotionIdentityComfortFinalRedactionSweep2(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_comfort_final_redaction_sweep2_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityComfortFinalNoSweeteningSweep2({
    final_redaction_sweep2_is_runtime_readiness: true,
    continuation_ledger_is_runtime_readiness: true,
    role_gate_is_owner_action: true,
    audit_stub_executes_audit: true,
    public_safe_summary_is_runtime_ready: true,
    completion_review_is_production_ready: true,
    experimental_labels_executable: true,
    runtime_motion_executable: true,
    strong_motion_ready: true,
    renderer_ready_claimed: true,
  ...
  assertLive2dMotionIdentityComfortFinalNoSweeteningSweep2(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_comfort_final_no_sweetening_sweep2_rejected_state_promotion"), true);
}
