...
import {
  ...
  LIVE2D_MOTION_IDENTITY_COMFORT_IMPLEMENTATION_GAP_AUDIT_ITEMS,
  LIVE2D_MOTION_IDENTITY_COMFORT_IMPLEMENTATION_GAP_AUDIT_REJECTIONS,
  LIVE2D_MOTION_IDENTITY_COMFORT_IMPLEMENTATION_GAP_REGISTER_SCHEMA,
  ...
  LIVE2D_MOTION_IDENTITY_COMFORT_FINAL_LONG_CONTINUATION_REVIEW2_REJECTIONS,
  LIVE2D_MOTION_IDENTITY_COMFORT_PUBLIC_SUMMARY_SCHEMA,
  LIVE2D_MOTION_IDENTITY_COMFORT_PUBLIC_SUMMARY_SECTIONS,
  LIVE2D_MOTION_IDENTITY_COMFORT_PUBLIC_SUMMARY_ALLOWED_LABELS,
  LIVE2D_MOTION_IDENTITY_COMFORT_PUBLIC_SUMMARY_REJECTIONS,
  ...
  LIVE2D_RENDERER_READY_REAL_PROBE_REQUEST_STUB_SCHEMA,
  LIVE2D_RENDERER_READY_REAL_PROBE_REQUEST_REJECTION_GATE_SCHEMA,
  LIVE2D_RENDERER_READY_REAL_PROBE_REQUEST_REJECTION_REASONS,
  LIVE2D_RENDERER_READY_REAL_PROBE_PREFLIGHT_BLOCKER_MATRIX_SCHEMA,
  ...
  LIVE2D_RENDERER_READY_FINAL_PRE_OWNER_BLOCKER_SUMMARY_SCHEMA,
  ...
  LIVE2D_RENDERER_READY_PRE_OWNER_WAIT_STATE2_SCHEMA,
  LIVE2D_RENDERER_READY_PRE_OWNER_WAIT_STATE2_ITEMS,
  ...
  LIVE2D_RENDERER_READY_SAFE_OPERATOR_CHECKLIST_REDACTION_GUARD_SCHEMA,
  LIVE2D_RENDERER_READY_SAFE_OPERATOR_CHECKLIST_SAFE_REJECTION_LABELS,
  LIVE2D_RENDERER_READY_REAL_EVIDENCE_REQUEST_FINAL_NO_GO_SCHEMA,
  LIVE2D_RENDERER_READY_REAL_EVIDENCE_REQUEST_NO_GO_REASONS,
  LIVE2D_RENDERER_READY_PREFLIGHT_ROUTE_MANIFEST_STUB_SCHEMA,
  LIVE2D_RENDERER_READY_PREFLIGHT_ROUTE_REQUIRED_SECTIONS,
  LIVE2D_RENDERER_READY_PREFLIGHT_ROUTE_UNSAFE_FIELD_GUARD_SCHEMA,
  LIVE2D_RENDERER_READY_PREFLIGHT_ROUTE_SAFE_REJECTION_LABELS,
  ...
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_REJECTION_FIXTURE_PACK_SCHEMA,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_DRY_RUN_VALIDATOR_SCHEMA,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_RECOVERY_MATRIX_SCHEMA,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_CONTEXT_GATE_SCHEMA,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_SUBTITLE_GAZE_GUARD_SCHEMA,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_PERSONA_PRESSURE_GUARD_SCHEMA,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_VOICE_SYNC_HINT_BOUNDARY_SCHEMA,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_ADAPTIVE_BOUNDS_SCHEMA,
  LIVE2D_MOTION_IDENTITY_COMFORT_DEVELOPMENT_SCHEDULE_SCHEMA,
  LIVE2D_MOTION_IDENTITY_COMFORT_COMPLETION_REVIEW_SCHEMA,
  LIVE2D_MOTION_IDENTITY_PROFILE_STATUS_SURFACE_SCHEMA,
  ...
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_RULES,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_ACCEPTED_FIXTURE_CASES,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_REJECTED_FIXTURE_CASES,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_DRY_RUN_REQUIRED_INPUT_LABELS,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_DRY_RUN_REJECTION_REASONS,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_RECOVERY_MATRIX_REQUIRED_FIELDS,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_RECOVERY_MATRIX_ROWS,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_RECOVERY_MATRIX_BLOCKERS,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_CONTEXT_GATE_REQUIRED_LABELS,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_CONTEXT_GATE_REJECTIONS,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_SUBTITLE_GAZE_REQUIRED_LABELS,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_SUBTITLE_GAZE_REJECTIONS,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_PERSONA_PRESSURE_REQUIRED_LABELS,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_PERSONA_PRESSURE_REJECTIONS,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_VOICE_SYNC_HINT_REQUIRED_LABELS,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_VOICE_SYNC_HINT_REJECTIONS,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_ADAPTIVE_BOUNDS_REQUIRED_LABELS,
  LIVE2D_MOTION_IDENTITY_AND_COMFORT_ADAPTIVE_BOUNDS_REJECTIONS,
  LIVE2D_MOTION_IDENTITY_COMFORT_DEVELOPMENT_SCHEDULE_PHASES,
  LIVE2D_MOTION_IDENTITY_COMFORT_DEVELOPMENT_SCHEDULE_BOUNDARIES,
  LIVE2D_MOTION_IDENTITY_COMFORT_COMPLETION_REVIEW_COMPLETED_ITEMS,
  LIVE2D_MOTION_IDENTITY_COMFORT_COMPLETION_REVIEW_OPEN_BLOCKERS,
  LIVE2D_MOTION_IDENTITY_COMFORT_COMPLETION_REVIEW_REJECTIONS,
  LIVE2D_MOTION_IDENTITY_PROFILE_STATUS_SAFE_LABELS,
  LIVE2D_MOTION_IDENTITY_PROFILE_STATUS_REJECTIONS,
  LIVE2D_MOTION_COMFORT_POLICY_STATUS_LABELS,
  LIVE2D_MOTION_COMFORT_POLICY_STATUS_REJECTIONS,
  ...
  LIVE2D_MOTION_IDENTITY_COMFORT_NO_SWEETENING_SWEEP_INPUTS,
  ...
  createLive2dMotionIdentityAndComfortRejectionFixturePackSummary,
  createLive2dMotionIdentityAndComfortDryRunValidatorSummary,
  createLive2dMotionIdentityAndComfortRecoveryMatrixSummary,
  createLive2dMotionIdentityAndComfortContextGateSummary,
  createLive2dMotionIdentityAndComfortSubtitleGazeGuardSummary,
  createLive2dMotionIdentityAndComfortPersonaPressureGuardSummary,
  ...
  createLive2dMotionIdentityProfileStatusSurfaceSummary,
...
try {
  ...
  assertLive2dMotionIdentityAndComfortSpec(provisionedRuntimeConfig.live2d_motion_identity_and_comfort_spec_summary);
  assertLive2dMotionIdentityAndComfortRejectionFixturePack(provisionedRuntimeConfig.live2d_motion_identity_and_comfort_rejection_fixture_pack_summary);
  assertLive2dMotionIdentityAndComfortDryRunValidator(provisionedRuntimeConfig.live2d_motion_identity_and_comfort_dry_run_validator_summary);
  assertLive2dMotionIdentityAndComfortRecoveryMatrix(provisionedRuntimeConfig.live2d_motion_identity_and_comfort_recovery_matrix_summary);
  assertLive2dMotionIdentityAndComfortContextGate(provisionedRuntimeConfig.live2d_motion_identity_and_comfort_context_gate_summary);
  assertLive2dMotionIdentityAndComfortSubtitleGazeGuard(provisionedRuntimeConfig.live2d_motion_identity_and_comfort_subtitle_gaze_guard_summary);
  assertLive2dMotionIdentityAndComfortPersonaPressureGuard(provisionedRuntimeConfig.live2d_motion_identity_and_comfort_persona_pressure_guard_summary);
  assertLive2dMotionIdentityAndComfortVoiceSyncHintBoundary(provisionedRuntimeConfig.live2d_motion_identity_and_comfort_voice_sync_hint_boundary_summary);
  assertLive2dMotionIdentityAndComfortAdaptiveBounds(provisionedRuntimeConfig.live2d_motion_identity_and_comfort_adaptive_bounds_summary);
  assertLive2dMotionIdentityComfortDevelopmentSchedule(provisionedRuntimeConfig.live2d_motion_identity_comfort_development_schedule_summary);
  assertLive2dMotionIdentityComfortCompletionReview(provisionedRuntimeConfig.live2d_motion_identity_comfort_completion_review_summary);
  assertLive2dMotionIdentityProfileStatusSurface(provisionedRuntimeConfig.live2d_motion_identity_profile_status_surface_summary);
  ...
  assertLive2dMotionIdentityComfortNoSweeteningSweep(provisionedRuntimeConfig.live2d_motion_identity_comfort_no_sweetening_sweep_summary);
  assertLive2dMotionIdentityComfortImplementationGapAudit(provisionedRuntimeConfig.live2d_motion_identity_comfort_implementation_gap_audit_summary);
  assertLive2dMotionIdentityComfortImplementationGapRegister(provisionedRuntimeConfig.live2d_motion_identity_comfort_implementation_gap_register_summary);
  assertLive2dMotionIdentityComfortFinalLongContinuationReview2(provisionedRuntimeConfig.live2d_motion_identity_comfort_final_long_continuation_review2_summary);
  assertLive2dMotionIdentityComfortPublicSummary(provisionedRuntimeConfig.live2d_motion_identity_comfort_public_summary);
  ...
  assertRendererReadyRealProbeRequestStub(provisionedRuntimeConfig.renderer_ready_real_probe_request_stub_summary);
  ...
  assertRendererReadyPreOwnerWaitState2(provisionedRuntimeConfig.renderer_ready_pre_owner_wait_state2_summary);
  ...
  assertRendererReadySafeOperatorChecklistRedactionGuard(provisionedRuntimeConfig.renderer_ready_safe_operator_checklist_redaction_guard_summary);
  assertRendererReadyRealEvidenceRequestFinalNoGo(provisionedRuntimeConfig.renderer_ready_real_evidence_request_final_no_go_summary);
  assertRendererReadyPreflightRouteManifestStub(provisionedRuntimeConfig.renderer_ready_preflight_route_manifest_stub_summary);
  assertRendererReadyPreflightRouteUnsafeFieldGuard(provisionedRuntimeConfig.renderer_ready_preflight_route_unsafe_field_guard_summary);
  ...
  assertLive2dMotionIdentityAndComfortSpec(provisionedStatus.live2d_motion_identity_and_comfort_spec_summary);
  assertLive2dMotionIdentityAndComfortRejectionFixturePack(provisionedStatus.live2d_motion_identity_and_comfort_rejection_fixture_pack_summary);
  assertLive2dMotionIdentityAndComfortDryRunValidator(provisionedStatus.live2d_motion_identity_and_comfort_dry_run_validator_summary);
  assertLive2dMotionIdentityAndComfortRecoveryMatrix(provisionedStatus.live2d_motion_identity_and_comfort_recovery_matrix_summary);
  assertLive2dMotionIdentityAndComfortContextGate(provisionedStatus.live2d_motion_identity_and_comfort_context_gate_summary);
  assertLive2dMotionIdentityAndComfortSubtitleGazeGuard(provisionedStatus.live2d_motion_identity_and_comfort_subtitle_gaze_guard_summary);
  assertLive2dMotionIdentityAndComfortPersonaPressureGuard(provisionedStatus.live2d_motion_identity_and_comfort_persona_pressure_guard_summary);
  assertLive2dMotionIdentityAndComfortVoiceSyncHintBoundary(provisionedStatus.live2d_motion_identity_and_comfort_voice_sync_hint_boundary_summary);
  assertLive2dMotionIdentityAndComfortAdaptiveBounds(provisionedStatus.live2d_motion_identity_and_comfort_adaptive_bounds_summary);
  assertLive2dMotionIdentityComfortDevelopmentSchedule(provisionedStatus.live2d_motion_identity_comfort_development_schedule_summary);
  assertLive2dMotionIdentityComfortCompletionReview(provisionedStatus.live2d_motion_identity_comfort_completion_review_summary);
  assertLive2dMotionIdentityProfileStatusSurface(provisionedStatus.live2d_motion_identity_profile_status_surface_summary);
  ...
  assertLive2dMotionIdentityComfortNoSweeteningSweep(provisionedStatus.live2d_motion_identity_comfort_no_sweetening_sweep_summary);
  assertLive2dMotionIdentityComfortImplementationGapAudit(provisionedStatus.live2d_motion_identity_comfort_implementation_gap_audit_summary);
  assertLive2dMotionIdentityComfortImplementationGapRegister(provisionedStatus.live2d_motion_identity_comfort_implementation_gap_register_summary);
  assertLive2dMotionIdentityComfortFinalLongContinuationReview2(provisionedStatus.live2d_motion_identity_comfort_final_long_continuation_review2_summary);
  assertLive2dMotionIdentityComfortPublicSummary(provisionedStatus.live2d_motion_identity_comfort_public_summary);
  ...
  assertRendererReadyRealProbeRequestStub(provisionedStatus.renderer_ready_real_probe_request_stub_summary);
  ...
  assertRendererReadyPreOwnerWaitState2(provisionedStatus.renderer_ready_pre_owner_wait_state2_summary);
  ...
  assertRendererReadySafeOperatorChecklistRedactionGuard(provisionedStatus.renderer_ready_safe_operator_checklist_redaction_guard_summary);
  assertRendererReadyRealEvidenceRequestFinalNoGo(provisionedStatus.renderer_ready_real_evidence_request_final_no_go_summary);
  assertRendererReadyPreflightRouteManifestStub(provisionedStatus.renderer_ready_preflight_route_manifest_stub_summary);
  assertRendererReadyPreflightRouteUnsafeFieldGuard(provisionedStatus.renderer_ready_preflight_route_unsafe_field_guard_summary);
  ...
  assertLive2dMotionIdentityAndComfortSpec(provisionedHealth.live2d_motion_identity_and_comfort_spec_summary);
  assertLive2dMotionIdentityAndComfortRejectionFixturePack(provisionedHealth.live2d_motion_identity_and_comfort_rejection_fixture_pack_summary);
  assertLive2dMotionIdentityAndComfortDryRunValidator(provisionedHealth.live2d_motion_identity_and_comfort_dry_run_validator_summary);
  assertLive2dMotionIdentityAndComfortRecoveryMatrix(provisionedHealth.live2d_motion_identity_and_comfort_recovery_matrix_summary);
  assertLive2dMotionIdentityAndComfortContextGate(provisionedHealth.live2d_motion_identity_and_comfort_context_gate_summary);
  assertLive2dMotionIdentityAndComfortSubtitleGazeGuard(provisionedHealth.live2d_motion_identity_and_comfort_subtitle_gaze_guard_summary);
  assertLive2dMotionIdentityAndComfortPersonaPressureGuard(provisionedHealth.live2d_motion_identity_and_comfort_persona_pressure_guard_summary);
  assertLive2dMotionIdentityAndComfortVoiceSyncHintBoundary(provisionedHealth.live2d_motion_identity_and_comfort_voice_sync_hint_boundary_summary);
  assertLive2dMotionIdentityAndComfortAdaptiveBounds(provisionedHealth.live2d_motion_identity_and_comfort_adaptive_bounds_summary);
  assertLive2dMotionIdentityComfortDevelopmentSchedule(provisionedHealth.live2d_motion_identity_comfort_development_schedule_summary);
  assertLive2dMotionIdentityComfortCompletionReview(provisionedHealth.live2d_motion_identity_comfort_completion_review_summary);
  assertLive2dMotionIdentityProfileStatusSurface(provisionedHealth.live2d_motion_identity_profile_status_surface_summary);
  ...
  assertLive2dMotionIdentityComfortNoSweeteningSweep(provisionedHealth.live2d_motion_identity_comfort_no_sweetening_sweep_summary);
  assertLive2dMotionIdentityComfortImplementationGapAudit(provisionedHealth.live2d_motion_identity_comfort_implementation_gap_audit_summary);
  assertLive2dMotionIdentityComfortImplementationGapRegister(provisionedHealth.live2d_motion_identity_comfort_implementation_gap_register_summary);
  assertLive2dMotionIdentityComfortFinalLongContinuationReview2(provisionedHealth.live2d_motion_identity_comfort_final_long_continuation_review2_summary);
  assertLive2dMotionIdentityComfortPublicSummary(provisionedHealth.live2d_motion_identity_comfort_public_summary);
  ...
  assertRendererReadyRealProbeRequestStub(provisionedHealth.renderer_ready_real_probe_request_stub_summary);
  ...
  assertRendererReadyPreOwnerWaitState2(provisionedHealth.renderer_ready_pre_owner_wait_state2_summary);
  ...
  assertRendererReadySafeOperatorChecklistRedactionGuard(provisionedHealth.renderer_ready_safe_operator_checklist_redaction_guard_summary);
  assertRendererReadyRealEvidenceRequestFinalNoGo(provisionedHealth.renderer_ready_real_evidence_request_final_no_go_summary);
  assertRendererReadyPreflightRouteManifestStub(provisionedHealth.renderer_ready_preflight_route_manifest_stub_summary);
  assertRendererReadyPreflightRouteUnsafeFieldGuard(provisionedHealth.renderer_ready_preflight_route_unsafe_field_guard_summary);
  ...
  assertRendererReadyOwnerEvidenceHandoffPacketStubConsistency({
    runtimeConfig: provisionedRuntimeConfig.renderer_ready_owner_evidence_handoff_packet_stub_summary,
    status: provisionedStatus.renderer_ready_owner_evidence_handoff_packet_stub_summary,
    health: provisionedHealth.renderer_ready_owner_evidence_handoff_packet_stub_summary,
  });
  ...
  assert.equal(completionIndex.includes("LIVE2D-MOTION-IDENTITY-AND-COMFORT-SPEC1"), true);
  assert.equal(completionIndex.includes("| motion identity and comfort spec | complete |"), true);
  assert.equal(completionIndex.includes("LIVE2D-MOTION-IDENTITY-AND-COMFORT-REJECTION-FIXTURE-PACK1"), true);
  assert.equal(completionIndex.includes("| motion identity and comfort rejection fixture pack | complete |"), true);
  assert.equal(completionIndex.includes("LIVE2D-MOTION-IDENTITY-AND-COMFORT-DRY-RUN-VALIDATOR1"), true);
  assert.equal(completionIndex.includes("| motion identity and comfort dry-run validator | complete |"), true);
  assert.equal(completionIndex.includes("LIVE2D-MOTION-IDENTITY-AND-COMFORT-RECOVERY-MATRIX1"), true);
  assert.equal(completionIndex.includes("| motion identity and comfort recovery matrix | complete |"), true);
  assert.equal(completionIndex.includes("LIVE2D-MOTION-IDENTITY-AND-COMFORT-CONTEXT-GATE1"), true);
  assert.equal(completionIndex.includes("| motion identity and comfort context gate | complete |"), true);
  assert.equal(completionIndex.includes("LIVE2D-MOTION-IDENTITY-AND-COMFORT-SUBTITLE-GAZE-GUARD1"), true);
  assert.equal(completionIndex.includes("| motion identity and comfort subtitle/gaze guard | complete |"), true);
  assert.equal(completionIndex.includes("LIVE2D-MOTION-IDENTITY-AND-COMFORT-PERSONA-PRESSURE-GUARD1"), true);
  assert.equal(completionIndex.includes("| motion identity and comfort persona pressure guard | complete |"), true);
  assert.equal(completionIndex.includes("| persona_pressure_guard_executes_motion | false |"), true);
  assert.equal(completionIndex.includes("LIVE2D-MOTION-IDENTITY-AND-COMFORT-VOICE-SYNC-HINT-BOUNDARY1"), true);
  assert.equal(completionIndex.includes("| motion identity and comfort voice sync hint boundary | complete |"), true);
  assert.equal(completionIndex.includes("| voice_sync_hint_executes_motion | false |"), true);
  assert.equal(completionIndex.includes("LIVE2D-MOTION-IDENTITY-AND-COMFORT-ADAPTIVE-BOUNDS1"), true);
  assert.equal(completionIndex.includes("| motion identity and comfort adaptive bounds | complete |"), true);
  assert.equal(completionIndex.includes("| adaptive_bounds_executes_motion | false |"), true);
  assert.equal(completionIndex.includes("LIVE2D-MOTION-IDENTITY-COMFORT-DEVELOPMENT-SCHEDULE1"), true);
  assert.equal(completionIndex.includes("| motion identity comfort development schedule | complete |"), true);
  assert.equal(completionIndex.includes("| schedule_executes_motion | false |"), true);
  assert.equal(completionIndex.includes("| subtitle_gaze_guard_executes_motion | false |"), true);
  assert.equal(completionIndex.includes("| context_gate_executes_motion | false |"), true);
  assert.equal(completionIndex.includes("| recovery_matrix_executes_motion | false |"), true);
  assert.equal(completionIndex.includes("| dry_run_validator_executes_motion | false |"), true);
  assert.equal(completionIndex.includes("| strong_motion_without_recovery_allowed | false |"), true);
  assert.equal(completionIndex.includes("| renderer_ready_candidate | false |"), true);
  assert.equal(completionIndex.includes("| trusted_loader_allowlist_enabled | false |"), true);
  ...
  console.log(JSON.stringify({
    ...
    checked: [
      ...
      "live2d_motion_identity_and_comfort_spec",
      "live2d_motion_identity_and_comfort_rejection_fixture_pack",
      "live2d_motion_identity_and_comfort_dry_run_validator",
      "live2d_motion_identity_and_comfort_recovery_matrix",
      "live2d_motion_identity_and_comfort_context_gate",
      "live2d_motion_identity_and_comfort_subtitle_gaze_guard",
      "live2d_motion_identity_and_comfort_persona_pressure_guard",
      "live2d_motion_identity_and_comfort_voice_sync_hint_boundary",
      "live2d_motion_identity_and_comfort_adaptive_bounds",
      "live2d_motion_identity_comfort_development_schedule",
      "live2d_motion_identity_comfort_completion_review",
      "live2d_motion_identity_profile_status_surface",
      ...
      "live2d_motion_identity_comfort_no_sweetening_sweep",
      "live2d_motion_identity_comfort_implementation_gap_audit",
      "live2d_motion_identity_comfort_implementation_gap_register",
      "live2d_motion_identity_comfort_final_long_continuation_review2",
      "live2d_motion_identity_comfort_public_summary",
      ...
      "renderer_ready_real_probe_request_stub",
      ...
      "renderer_ready_pre_owner_wait_state2",
      ...
      "renderer_ready_preflight_route_manifest_stub",
      "renderer_ready_preflight_route_unsafe_field_guard",
...
function assertRendererReadyOwnerEvidenceHandoffPacketStub(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_OWNER_EVIDENCE_HANDOFF_PACKET_STUB_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.ownerEvidenceHandoffPacketStubStatus, "stub_not_sent");
  assert.equal(summary.handoffPacketSent, false);
  assert.equal(summary.handoffPacketAccepted, false);
  assert.deepEqual(summary.requiredStubItems, [...LIVE2D_RENDERER_READY_OWNER_EVIDENCE_HANDOFF_STUB_ITEMS]);
  assert.deepEqual(summary.missingEvidenceLabelsOnly, [...LIVE2D_RENDERER_READY_EVIDENCE_COMPLETENESS_MISSING_LABELS]);
...
function assertRendererReadyOwnerEvidenceHandoffPacketStubConsistency(surfaces) {
  const canonical = surfaces.runtimeConfig;
  for (const [surfaceName, summary] of Object.entries(surfaces)) {
    assertRendererReadyOwnerEvidenceHandoffPacketStub(summary);
    assert.equal(summary.ownerEvidenceHandoffPacketStubStatus, canonical.ownerEvidenceHandoffPacketStubStatus, surfaceName);
    assert.equal(summary.handoffPacketSent, canonical.handoffPacketSent, surfaceName);
    assert.deepEqual(summary.requiredStubItems, canonical.requiredStubItems, surfaceName);
    assert.deepEqual(summary.missingEvidenceLabelsOnly, canonical.missingEvidenceLabelsOnly, surfaceName);
  }
}

function assertRendererReadyOwnerHandoffNotSentGuard(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_OWNER_HANDOFF_NOT_SENT_GUARD_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.ownerEvidenceHandoffPacketStatus, "draft_not_sent");
...
function assertRendererReadyRealProbeRequestStub(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_REAL_PROBE_REQUEST_STUB_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.rendererProbeRequestStatus, "draft_not_sent");
  ...
  assert.equal(summary.ownerConfirmationRequired, true);
  assert.equal(summary.ownerConfirmationConfirmed, false);
  assert.equal(summary.ownerConfirmationCreated, false);
  assert.equal(summary.rendererReadyClaimed, false);
  assert.equal(summary.rendererReadyCandidate, false);
...
function assertRendererReadyRealProbeRequestRejectionGate(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_REAL_PROBE_REQUEST_REJECTION_GATE_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.realProbeRequestRejectionGateStatus, "reject");
  assert.equal(summary.unsafeRequestRejected, true);
  assert.deepEqual(summary.rejectionReasons, [...LIVE2D_RENDERER_READY_REAL_PROBE_REQUEST_REJECTION_REASONS]);
  assert.equal(summary.sourceValueEchoed, false);
  assert.equal(summary.rendererProbeRequested, false);
  assert.equal(summary.rendererProbeExecuted, false);
  assert.equal(summary.realRendererEvidencePresent, false);
...
function assertRendererReadyRealProbePreflightBlockerMatrix(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_REAL_PROBE_PREFLIGHT_BLOCKER_MATRIX_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.realProbePreflightStatus, "no_go");
  assert.equal(summary.probeAllowed, false);
  assert.deepEqual(summary.blockers, [...LIVE2D_RENDERER_READY_REAL_PROBE_PREFLIGHT_BLOCKERS]);
  assert.equal(summary.rendererProbeRequested, false);
  assert.equal(summary.rendererProbeExecuted, false);
  assert.equal(summary.realRendererEvidencePresent, false);
  assert.equal(summary.ownerConfirmationConfirmed, false);
...
function assertRendererReadyEvidenceCollectorManifestStub(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_EVIDENCE_COLLECTOR_MANIFEST_STUB_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.evidenceCollectorManifestStatus, "stub_not_executed");
  assert.deepEqual(summary.collectorLabels, [...LIVE2D_RENDERER_READY_EVIDENCE_COLLECTOR_LABELS]);
...
function assertRendererReadyEvidenceCollectorSafeOutputSchema(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_EVIDENCE_COLLECTOR_SAFE_OUTPUT_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.collectorSafeOutputSchemaStatus, "schema_only_not_output");
  assert.deepEqual(summary.safeOutputFields, [...LIVE2D_RENDERER_READY_EVIDENCE_COLLECTOR_SAFE_OUTPUT_FIELDS]);
  assert.equal(summary.safeOutputFields.includes("collector_name"), true);
  assert.equal(summary.safeOutputFields.includes("safe_next_action_label"), true);
  assert.equal(summary.collectorOutputGenerated, false);
  assert.equal(summary.collectorOutputAcceptedAsRealEvidence, false);
  assert.equal(summary.realEvidenceCollectionStarted, false);
  assert.equal(summary.realRendererEvidencePresent, false);
  ...
  assert.equal(summary.endpointAllowed, false);
  assert.equal(summary.tokenAllowed, false);
  assert.equal(summary.secretAllowed, false);
  assert.equal(summary.rawRendererPayloadAllowed, false);
  assert.equal(summary.rawCuePayloadAllowed, false);
  assert.equal(summary.rawModelPathAllowed, false);
  assert.equal(summary.rawMotionPathAllowed, false);
  assert.equal(summary.collectorExecutionAllowed, false);
  assert.equal(summary.collectorExecutionStarted, false);
  assert.equal(summary.collectorsExecuted, false);
  assert.equal(summary.rendererProbeExecuted, false);
  ...
  assert.equal(summary.trustedLoaderAllowlistEnabled, false);
  assert.equal(summary.trusted_loader_allowlist_enabled, false);
  assert.equal(summary.boundary_policy.safe_output_schema_only, true);
  assert.equal(summary.boundary_policy.no_collector_output_generation, true);
  assert.equal(summary.boundary_policy.no_collector_output_accepted_as_real_evidence, true);
...
function assertRendererReadyPublicSummaryRedaction(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_PUBLIC_SUMMARY_REDACTION_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.publicSummaryRedactionStatus, "safe_labels_counts_status_only");
  assert.equal(summary.publicSurface, true);
  assert.equal(summary.safeLabelsOnly, true);
  assert.equal(summary.safeCountsOnly, true);
  assert.equal(summary.safeStatusOnly, true);
  assert.equal(summary.publicDetailLevel, "minimal_status");
  assert.equal(summary.forbiddenMaterialPresent, false);
  assert.equal(summary.networkLocatorMaterialPresent, false);
  assert.equal(summary.authMaterialPresent, false);
  assert.equal(summary.confidentialMaterialPresent, false);
  assert.equal(summary.rendererMaterialPresent, false);
  assert.equal(summary.cueMaterialPresent, false);
  assert.equal(summary.modelReferenceMaterialPresent, false);
  assert.equal(summary.motionReferenceMaterialPresent, false);
  assert.equal(summary.operatorInstructionMaterialPresent, false);
  assert.equal(summary.processDiagnosticMaterialPresent, false);
  assert.equal(summary.ownerOnlyDetailPresent, false);
  assert.equal(summary.publicSummaryFieldCount, 12);
  assert.equal(summary.allowedPublicFields.includes("readinessStatus"), true);
  assert.equal(summary.allowedPublicFields.includes("safeNextAction"), true);
  ...
  assert.equal(summary.checkedRowCount, 0);
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.motionDatasetBoundary, "non_executable");
  assert.equal(summary.motionDatasetExecutable, false);
  assert.equal(summary.motion_dataset_executable, false);
  assert.equal(summary.trustedLoaderBoundary, "disabled");
  assert.equal(summary.trustedLoaderAllowlistEnabled, false);
  assert.equal(summary.trusted_loader_allowlist_enabled, false);
  assert.equal(summary.collectorBoundary, "not_executed");
  assert.equal(summary.collectorExecutionStarted, false);
  assert.equal(summary.collectorOutputGenerated, false);
  assert.equal(summary.collectorOutputAcceptedAsRealEvidence, false);
  assert.equal(summary.realEvidenceCollectionStarted, false);
  assert.equal(summary.realRendererEvidencePresent, false);
  assert.equal(summary.ownerConfirmationStatus, "absent");
  assert.equal(summary.ownerConfirmationCreated, false);
  assert.equal(summary.ownerConfirmationConfirmed, false);
  assert.equal(summary.actualDataBoundary, "not_started");
  assert.equal(summary.actual_data_task_started, false);
  assert.equal(summary.actual_ingestion_allowed, false);
  assert.equal(summary.safeNextAction, "continue_safe_only_contract_work");
  assert.equal(summary.boundary_policy.public_summary_redaction_only, true);
  assert.equal(summary.boundary_policy.safe_status_only, true);
  assert.equal(summary.boundary_policy.safe_labels_only, true);
  assert.equal(summary.boundary_policy.safe_counts_only, true);
  assert.equal(summary.boundary_policy.no_forbidden_material, true);
  assert.equal(summary.boundary_policy.no_owner_only_detail, true);
  assert.equal(summary.boundary_policy.no_collector_execution, true);
  assert.equal(summary.boundary_policy.no_collector_output_generation, true);
  assert.equal(summary.boundary_policy.no_collector_output_accepted_as_real_evidence, true);
  assert.equal(summary.boundary_policy.no_real_evidence_collection_started, true);
...
function assertRendererReadyAdminSummaryRedaction(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_ADMIN_SUMMARY_REDACTION_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.adminSummaryRedactionStatus, "ordinary_admin_safe_summary_only");
  assert.equal(summary.adminOrdinarySummary, true);
  assert.equal(summary.safeStatusOnly, true);
  assert.equal(summary.safeLabelsOnly, true);
  assert.equal(summary.diagnosticDetailLevel, "safe_status_no_values");
  ...
  assert.equal(summary.actual_data_task_started, false);
  assert.equal(summary.actual_ingestion_allowed, false);
  assert.equal(summary.boundary_policy.admin_summary_redaction_only, true);
  assert.equal(summary.boundary_policy.safe_status_only, true);
  assert.equal(summary.boundary_policy.safe_labels_only, true);
  assert.equal(summary.boundary_policy.no_forbidden_material, true);
  assert.equal(summary.boundary_policy.no_owner_only_detail, true);
  assert.equal(summary.boundary_policy.owner_only_detail_role_gated, true);
  assert.equal(summary.boundary_policy.no_collector_execution, true);
  assert.equal(summary.boundary_policy.no_collector_output_generation, true);
  assert.equal(summary.boundary_policy.no_collector_output_accepted_as_real_evidence, true);
  assert.equal(summary.boundary_policy.no_real_evidence_collection_started, true);
...
function assertRendererReadyFinalPreOwnerBlockerSummary(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_FINAL_PRE_OWNER_BLOCKER_SUMMARY_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.finalPreOwnerBlockerSummaryStatus, "blocked_safe_labels_only");
  assert.equal(summary.blockerSummaryOnly, true);
  assert.deepEqual(summary.remainingBlockers, [...LIVE2D_RENDERER_READY_FINAL_PRE_OWNER_BLOCKERS]);
  assert.equal(summary.remainingBlockerCount, LIVE2D_RENDERER_READY_FINAL_PRE_OWNER_BLOCKERS.length);
  assert.equal(summary.remainingBlockers.includes("explicit_owner_action_missing"), true);
  assert.equal(summary.remainingBlockers.includes("real_renderer_probe_missing"), true);
  assert.equal(summary.remainingBlockers.includes("trusted_loader_disabled"), true);
  assert.equal(summary.explicitOwnerActionReceived, false);
  assert.equal(summary.ownerConfirmationCreated, false);
  assert.equal(summary.ownerConfirmationConfirmed, false);
  assert.equal(summary.actualRendererProbeExecuted, false);
  assert.equal(summary.actualBrowserProbeExecuted, false);
  assert.equal(summary.realRendererEvidencePresent, false);
  assert.equal(summary.freshHeartbeatPresent, false);
  assert.equal(summary.realModelLoadSupported, false);
  assert.equal(summary.modelLoaded, false);
  assert.equal(summary.sceneLoaded, false);
  assert.equal(summary.cueCapabilityConfirmed, false);
  assert.equal(summary.lastCueApplied, false);
  ...
  assert.equal(summary.trustedLoaderAllowlistEnabled, false);
  assert.equal(summary.trusted_loader_allowlist_enabled, false);
  assert.equal(summary.boundary_policy.final_pre_owner_blocker_summary_only, true);
  assert.equal(summary.boundary_policy.safe_status_only, true);
  assert.equal(summary.boundary_policy.safe_labels_only, true);
  assert.equal(summary.boundary_policy.no_actual_renderer_probe, true);
  assert.equal(summary.boundary_policy.no_actual_browser_probe, true);
...
function assertRendererReadyLongContinuationCompletionReview2(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_LONG_CONTINUATION_COMPLETION_REVIEW2_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.longContinuationCompletionReviewStatus, "review_only_continue");
  assert.equal(summary.completionReviewOnly, true);
  assert.equal(summary.stopCondition, false);
  assert.deepEqual(summary.completedArtifacts, [...LIVE2D_RENDERER_READY_LONG_CONTINUATION_REVIEW2_COMPLETED_ARTIFACTS]);
  assert.equal(summary.completedArtifactCount, LIVE2D_RENDERER_READY_LONG_CONTINUATION_REVIEW2_COMPLETED_ARTIFACTS.length);
  assert.equal(summary.completedArtifacts.includes("public_summary_redaction"), true);
  assert.equal(summary.completedArtifacts.includes("final_pre_owner_blocker_summary"), true);
  ...
  assert.equal(summary.trustedLoaderAllowlistEnabled, false);
  assert.equal(summary.trusted_loader_allowlist_enabled, false);
  assert.equal(summary.boundary_policy.long_continuation_completion_review2_only, true);
  assert.equal(summary.boundary_policy.completion_review_is_not_stop_condition, true);
  assert.equal(summary.boundary_policy.no_actual_renderer_probe, true);
  assert.equal(summary.boundary_policy.no_actual_browser_probe, true);
  assert.equal(summary.boundary_policy.no_actual_live2d_execution, true);
  assert.equal(summary.boundary_policy.no_collector_execution, true);
...
function assertRendererReadyPreOwnerWaitState2(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_PRE_OWNER_WAIT_STATE2_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.preOwnerWaitStateStatus, "waiting_safe_labels_only");
  assert.equal(summary.waitStateOnly, true);
  assert.deepEqual(summary.waitItems, [...LIVE2D_RENDERER_READY_PRE_OWNER_WAIT_STATE2_ITEMS]);
  assert.equal(summary.waitItemCount, LIVE2D_RENDERER_READY_PRE_OWNER_WAIT_STATE2_ITEMS.length);
  assert.equal(summary.waitItems.includes("owner_confirmation_missing"), true);
  assert.equal(summary.waitItems.includes("trusted_loader_disabled"), true);
  assert.equal(summary.nextSafeTask, "owner_action_boundary_catalog2");
  assert.equal(summary.ownerActionRequestedBySystem, false);
  assert.equal(summary.ownerHandoffSent, false);
  assert.equal(summary.ownerConfirmationCreated, false);
  assert.equal(summary.ownerConfirmationConfirmed, false);
  assert.equal(summary.actualRendererProbeExecuted, false);
  assert.equal(summary.actualBrowserProbeExecuted, false);
  ...
  assert.equal(summary.trustedLoaderAllowlistEnabled, false);
  assert.equal(summary.trusted_loader_allowlist_enabled, false);
  assert.equal(summary.boundary_policy.pre_owner_wait_state2_only, true);
  assert.equal(summary.boundary_policy.wait_state_is_not_owner_confirmation, true);
  assert.equal(summary.boundary_policy.no_owner_handoff_sent, true);
  assert.equal(summary.boundary_policy.no_owner_confirmation_creation, true);
  assert.equal(summary.boundary_policy.no_actual_renderer_probe, true);
  assert.equal(summary.boundary_policy.no_collector_execution, true);
...
function assertRendererReadyAuditReferenceStub(summary) {
  ...
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.rendererReadinessAuditReferenceRequired, true);
  assert.equal(summary.rendererReadinessAuditReferencePresent, false);
  assert.equal(summary.rendererReadinessAuditEntryCreated, false);
  assert.equal(summary.auditExecutionStarted, false);
  assert.equal(summary.sourceValueEchoed, false);
  assert.equal(summary.rendererProbeExecuted, false);
  assert.equal(summary.realRendererEvidencePresent, false);
...
function assertRendererReadyAuditReferenceMissingGuard(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_AUDIT_REFERENCE_MISSING_GUARD_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.auditReferencePresent, false);
  assert.equal(summary.auditReferenceMissing, true);
  assert.equal(summary.auditReferenceMissingReason, "audit_reference_missing");
  assert.equal(summary.rendererReadinessAuditReferencePresent, false);
  assert.equal(summary.rendererReadinessAuditEntryCreated, false);
  assert.equal(summary.auditExecutionStarted, false);
  assert.equal(summary.sourceValueEchoed, false);
  ...
  assert.equal(summary.trustedLoaderAllowlistEnabled, false);
  assert.equal(summary.trusted_loader_allowlist_enabled, false);
  assert.equal(summary.boundary_policy.audit_reference_missing_guard_only, true);
  assert.equal(summary.boundary_policy.no_audit_execution, true);
  assert.equal(summary.boundary_policy.no_actual_renderer_probe, true);
  assert.equal(summary.boundary_policy.no_owner_confirmation_creation, true);
  assert.equal(summary.boundary_policy.no_readiness_claim, true);
...
function assertRendererReadySafeOperatorChecklistStub(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_SAFE_OPERATOR_CHECKLIST_STUB_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.operatorChecklistStatus, "draft_safe_stub");
  assert.equal(summary.operatorChecklistGenerated, true);
  assert.equal(summary.operatorChecklistExecuted, false);
  assert.equal(summary.operatorActionExecuted, false);
  assert.deepEqual(summary.safeChecklistItems, LIVE2D_RENDERER_READY_SAFE_OPERATOR_CHECKLIST_ITEMS);
  assert.equal(summary.safeChecklistItems.includes("confirm_owner_scope_later"), true);
  assert.equal(summary.safeChecklistItems.includes("do_not_claim_readiness_now"), true);
  assert.equal(summary.networkLocatorIncluded, false);
  assert.equal(summary.authMaterialIncluded, false);
  assert.equal(summary.locatorValueIncluded, false);
  assert.equal(summary.shellMaterialIncluded, false);
  assert.equal(summary.sourceValueEchoed, false);
  assert.equal(summary.ownerConfirmationCreated, false);
  assert.equal(summary.ownerConfirmationConfirmed, false);
  assert.equal(summary.rendererProbeExecuted, false);
  ...
  assert.equal(summary.motionDatasetExecutable, false);
  assert.equal(summary.trustedLoaderAllowlistEnabled, false);
  assert.equal(summary.boundary_policy.operator_checklist_stub_only, true);
  assert.equal(summary.boundary_policy.no_operator_action_execution, true);
  assert.equal(summary.boundary_policy.no_readiness_claim, true);
  assertSafe(JSON.stringify(summary));
}

function assertRendererReadySafeOperatorChecklistRedactionGuard(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_SAFE_OPERATOR_CHECKLIST_REDACTION_GUARD_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.operatorChecklistRedactionStatus, "safe_summary_only");
  assert.equal(summary.unsafeChecklistMaterialRejected, true);
  assert.deepEqual(summary.safeRejectionLabels, LIVE2D_RENDERER_READY_SAFE_OPERATOR_CHECKLIST_SAFE_REJECTION_LABELS);
  assert.equal(summary.safeRejectionLabels.includes("network_locator_material_rejected"), true);
  assert.equal(summary.safeRejectionLabels.includes("auth_material_rejected"), true);
  assert.equal(summary.shellMaterialRejected, true);
  assert.equal(summary.operatorMaterialRejected, true);
  assert.equal(summary.networkLocatorMaterialRejected, true);
  assert.equal(summary.authMaterialRejected, true);
  assert.equal(summary.modelLocatorMaterialRejected, true);
  assert.equal(summary.motionLocatorMaterialRejected, true);
  assert.equal(summary.rendererMaterialRejected, true);
  assert.equal(summary.evidenceBodyMaterialRejected, true);
  assert.equal(summary.ownerNoteMaterialRejected, true);
  assert.equal(summary.sourceValueEchoed, false);
  assert.equal(summary.operatorChecklistExecuted, false);
  assert.equal(summary.operatorActionExecuted, false);
  assert.equal(summary.ownerConfirmationCreated, false);
  ...
  assert.equal(summary.motionDatasetExecutable, false);
  assert.equal(summary.trustedLoaderAllowlistEnabled, false);
  assert.equal(summary.boundary_policy.operator_checklist_redaction_guard_only, true);
  assert.equal(summary.boundary_policy.no_source_value_echo, true);
  assert.equal(summary.boundary_policy.no_operator_action_execution, true);
  assert.equal(summary.boundary_policy.no_readiness_claim, true);
  assertSafe(JSON.stringify(summary));
...
function assertRendererReadyRealEvidenceRequestFinalNoGo(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_REAL_EVIDENCE_REQUEST_FINAL_NO_GO_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.realEvidenceRequestStatus, "no_go");
  assert.equal(summary.realEvidenceRequestSent, false);
  assert.equal(summary.realEvidenceCollectionStarted, false);
  assert.equal(summary.realRendererProbeStarted, false);
  assert.equal(summary.ownerConfirmationRequired, true);
  assert.equal(summary.ownerConfirmationConfirmed, false);
  assert.deepEqual(summary.noGoReasons, LIVE2D_RENDERER_READY_REAL_EVIDENCE_REQUEST_NO_GO_REASONS);
  assert.equal(summary.noGoReasons.includes("owner_confirmation_missing"), true);
  assert.equal(summary.noGoReasons.includes("trusted_loader_disabled"), true);
  assert.equal(summary.sourceValueEchoed, false);
  assert.equal(summary.rendererProbeExecuted, false);
  assert.equal(summary.realRendererEvidencePresent, false);
  assert.equal(summary.runtimeReadinessClaimed, false);
  ...
  assert.equal(summary.motionDatasetExecutable, false);
  assert.equal(summary.trustedLoaderAllowlistEnabled, false);
  assert.equal(summary.boundary_policy.real_evidence_request_final_no_go_only, true);
  assert.equal(summary.boundary_policy.no_real_evidence_request_send, true);
  assert.equal(summary.boundary_policy.no_real_evidence_collection_start, true);
  assert.equal(summary.boundary_policy.no_actual_renderer_probe, true);
  assert.equal(summary.boundary_policy.no_readiness_claim, true);
  assertSafe(JSON.stringify(summary));
}

function assertRendererReadyPreflightRouteManifestStub(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_PREFLIGHT_ROUTE_MANIFEST_STUB_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.preflightRouteManifestStatus, "draft");
  assert.equal(summary.preflightRouteExecuted, false);
  assert.equal(summary.realPreflightStarted, false);
  assert.deepEqual(summary.requiredPreflightSections, LIVE2D_RENDERER_READY_PREFLIGHT_ROUTE_REQUIRED_SECTIONS);
  assert.equal(summary.requiredPreflightSections.includes("renderer"), true);
  assert.equal(summary.requiredPreflightSections.includes("trusted_loader_boundary"), true);
  assert.equal(summary.networkLocatorIncluded, false);
  assert.equal(summary.authMaterialIncluded, false);
  assert.equal(summary.locatorValueIncluded, false);
  assert.equal(summary.sourceValueEchoed, false);
  ...
  assert.equal(summary.motionDatasetExecutable, false);
  assert.equal(summary.trustedLoaderAllowlistEnabled, false);
  assert.equal(summary.boundary_policy.preflight_route_manifest_stub_only, true);
  assert.equal(summary.boundary_policy.no_preflight_route_execution, true);
  assert.equal(summary.boundary_policy.no_real_preflight_start, true);
  assert.equal(summary.boundary_policy.no_readiness_claim, true);
  assertSafe(JSON.stringify(summary));
}

function assertRendererReadyPreflightRouteUnsafeFieldGuard(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_PREFLIGHT_ROUTE_UNSAFE_FIELD_GUARD_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.preflightRouteUnsafeFieldGuardStatus, "safe_summary_only");
  assert.equal(summary.unsafeFieldRejected, true);
  assert.deepEqual(summary.safeRejectionLabels, LIVE2D_RENDERER_READY_PREFLIGHT_ROUTE_SAFE_REJECTION_LABELS);
  assert.equal(summary.safeRejectionLabels.includes("network_locator_material_rejected"), true);
  assert.equal(summary.safeRejectionLabels.includes("auth_material_rejected"), true);
  assert.equal(summary.networkLocatorMaterialRejected, true);
  assert.equal(summary.authMaterialRejected, true);
  assert.equal(summary.privateLocatorMaterialRejected, true);
  assert.equal(summary.modelLocatorMaterialRejected, true);
  assert.equal(summary.motionLocatorMaterialRejected, true);
  assert.equal(summary.rendererMaterialRejected, true);
  assert.equal(summary.cueMaterialRejected, true);
  ...
  assert.equal(summary.motionDatasetExecutable, false);
  assert.equal(summary.trustedLoaderAllowlistEnabled, false);
  assert.equal(summary.boundary_policy.preflight_route_unsafe_field_guard_only, true);
  assert.equal(summary.boundary_policy.no_source_value_echo, true);
  assert.equal(summary.boundary_policy.no_preflight_route_execution, true);
  assert.equal(summary.boundary_policy.no_readiness_claim, true);
  assertSafe(JSON.stringify(summary));
...
function assertRendererReadyOwnerScopeRequirementSurface(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_OWNER_SCOPE_REQUIREMENT_SURFACE_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.ownerScopeRequired, true);
  assert.equal(summary.ownerScopeConfirmed, false);
  assert.equal(summary.ownerScopeStatus, "missing");
  assert.equal(summary.ownerScopeMissingBlocksRendererEvidence, true);
  assert.equal(summary.ownerScopeMissingBlocksReadiness, true);
  assert.equal(summary.probeAllowed, false);
  assert.equal(summary.sourceValueEchoed, false);
  assert.equal(summary.ownerConfirmationCreated, false);
  assert.equal(summary.ownerConfirmationConfirmed, false);
  ...
  assert.equal(summary.motionDatasetExecutable, false);
  assert.equal(summary.trustedLoaderAllowlistEnabled, false);
  assert.equal(summary.boundary_policy.owner_scope_requirement_surface_only, true);
  assert.equal(summary.boundary_policy.no_owner_confirmation_creation, true);
  assert.equal(summary.boundary_policy.no_actual_renderer_probe, true);
  assert.equal(summary.boundary_policy.no_readiness_claim, true);
  assertSafe(JSON.stringify(summary));
...
function assertRendererReadyOwnerScopeMissingRejectionGuard(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_OWNER_SCOPE_MISSING_REJECTION_GUARD_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.ownerScopeConfirmed, false);
  assert.equal(summary.ownerScopeStatus, "missing");
  assert.equal(summary.probeRequestRejected, true);
  assert.equal(summary.readinessRequestRejected, true);
  assert.equal(summary.rejectionReason, "owner_scope_missing");
  assert.equal(summary.probeAllowed, false);
  assert.equal(summary.sourceValueEchoed, false);
  assert.equal(summary.ownerConfirmationCreated, false);
  assert.equal(summary.ownerConfirmationConfirmed, false);
  ...
  assert.equal(summary.motionDatasetExecutable, false);
  assert.equal(summary.trustedLoaderAllowlistEnabled, false);
  assert.equal(summary.boundary_policy.owner_scope_missing_rejection_guard_only, true);
  assert.equal(summary.boundary_policy.no_actual_renderer_probe, true);
  assert.equal(summary.boundary_policy.no_readiness_claim, true);
  assertSafe(JSON.stringify(summary));
}

function assertRendererReadyAuditLinkRequirementSurface(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_AUDIT_LINK_REQUIREMENT_SURFACE_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.auditLinkRequired, true);
  assert.equal(summary.auditLinkPresent, false);
  assert.equal(summary.auditLinkStatus, "missing");
  assert.equal(summary.auditLinkMissingBlocksReadiness, true);
  assert.equal(summary.auditExecutionStarted, false);
  assert.equal(summary.auditBodyPresent, false);
  assert.equal(summary.sourceValueEchoed, false);
  assert.equal(summary.ownerConfirmationCreated, false);
  assert.equal(summary.ownerConfirmationConfirmed, false);
  assert.equal(summary.rendererProbeExecuted, false);
  ...
  assert.equal(summary.motionDatasetExecutable, false);
  assert.equal(summary.trustedLoaderAllowlistEnabled, false);
  assert.equal(summary.boundary_policy.audit_link_requirement_surface_only, true);
  assert.equal(summary.boundary_policy.no_audit_execution, true);
  assert.equal(summary.boundary_policy.no_readiness_claim, true);
  assertSafe(JSON.stringify(summary));
}
...
function assertRendererReadyTrustedLoaderPreauthBlockerSurface(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_TRUSTED_LOADER_PREAUTH_BLOCKER_SURFACE_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.trustedLoaderPreauthRequired, true);
  assert.equal(summary.trustedLoaderPreauthGranted, false);
  assert.equal(summary.trustedLoaderPreauthStatus, "blocked");
  assert.equal(summary.trustedLoaderEnablementRejected, true);
  assert.equal(summary.trustedLoaderAllowlistEnabled, false);
  assert.equal(summary.trusted_loader_allowlist_enabled, false);
  assert.equal(summary.trustedLoaderBoundary, "disabled");
  assert.equal(summary.loaderTrusted, false);
  assert.equal(summary.loaderAllowlistActive, false);
  assert.equal(summary.allowlistPreauthBlocked, true);
  assert.equal(summary.ownerConfirmationCreated, false);
  assert.equal(summary.ownerConfirmationConfirmed, false);
  assert.equal(summary.ownerScopeAccepted, false);
  assert.equal(summary.auditLinkPresent, false);
  assert.equal(summary.auditExecutionStarted, false);
  assert.equal(summary.rendererProbeExecuted, false);
  assert.equal(summary.realRendererEvidencePresent, false);
  ...
  assert.equal(summary.boundary_policy.trusted_loader_preauth_blocker_surface_only, true);
  assert.equal(summary.boundary_policy.no_trusted_loader_enablement, true);
  assert.equal(summary.boundary_policy.no_allowlist_enablement, true);
  assert.equal(summary.boundary_policy.no_loader_trusted_status, true);
  assert.equal(summary.boundary_policy.no_owner_confirmation_creation, true);
  assert.equal(summary.boundary_policy.no_audit_execution, true);
  assert.equal(summary.boundary_policy.no_actual_renderer_probe, true);
  assert.equal(summary.boundary_policy.no_actual_browser_probe, true);
...
function assertRendererReadyTrustedLoaderPreauthRejectionGuard(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_TRUSTED_LOADER_PREAUTH_REJECTION_GUARD_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.rejectedAttemptType, "trusted_loader_preauth_missing");
  assert.equal(summary.trustedLoaderEnablementRequested, true);
  assert.equal(summary.trustedLoaderEnablementRejected, true);
  assert.equal(summary.rejectionReason, "trusted_loader_preauth_missing");
  assert.equal(summary.trustedLoaderPreauthGranted, false);
  assert.equal(summary.trustedLoaderAllowlistEnabled, false);
  assert.equal(summary.trusted_loader_allowlist_enabled, false);
  assert.equal(summary.trustedLoaderBoundary, "disabled");
  ...
  assert.equal(summary.motionDatasetExecutable, false);
  assert.equal(summary.motion_dataset_executable, false);
  assert.equal(summary.boundary_policy.trusted_loader_preauth_rejection_guard_only, true);
  assert.equal(summary.boundary_policy.no_trusted_loader_enablement, true);
  assert.equal(summary.boundary_policy.no_allowlist_enablement, true);
  assert.equal(summary.boundary_policy.no_loader_trusted_status, true);
  assert.equal(summary.boundary_policy.no_owner_confirmation_creation, true);
...
function assertRendererReadyRuntimeReadinessFinalNoGo(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_RUNTIME_READINESS_FINAL_NO_GO_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.runtimeReadinessFinalNoGo, true);
  assert.equal(summary.runtimeReadinessClaimed, false);
  assert.equal(summary.runtimeReadinessStatus, "no_go");
  assert.equal(summary.runtimeReadinessApproved, false);
  assert.equal(summary.goApproved, false);
  assert.deepEqual(summary.runtimeReadinessNoGoReasons, [
    "owner_confirmation_missing",
    "real_renderer_evidence_missing",
  ...
  assert.equal(summary.motionDatasetExecutable, false);
  assert.equal(summary.motion_dataset_executable, false);
  assert.equal(summary.boundary_policy.runtime_readiness_final_no_go_only, true);
...
function assertRendererReadyExtendedGuardCompletionReview(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_EXTENDED_GUARD_COMPLETION_REVIEW_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.extendedGuardCompletionReview, true);
  assert.equal(summary.reviewedTaskRange, "DZ_to_ED");
  assert.deepEqual(summary.reviewedSafeGuards, [
  ...
  assert.equal(summary.completionReviewOnly, true);
  assert.equal(summary.stopAfterReview, false);
  assert.equal(summary.safeNextAction, "LIVE2D-RENDERER-READY-REAL-EVIDENCE-REQUEST-FINAL-WAIT-STATE1");
  assert.equal(summary.runtimeReadinessClaimed, false);
  assert.equal(summary.productionReadinessClaimed, false);
  assert.equal(summary.rendererReadyClaimed, false);
  assert.equal(summary.rendererReadyCandidate, false);
  ...
  assert.equal(summary.motionDatasetExecutable, false);
  assert.equal(summary.motion_dataset_executable, false);
  assert.equal(summary.boundary_policy.extended_guard_completion_review_only, true);
  assert.equal(summary.boundary_policy.no_stop_at_completion_review, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_owner_confirmation_creation, true);
  assert.equal(summary.boundary_policy.no_actual_data_task_started, true);
...
function assertRendererReadyRealEvidenceRequestFinalWaitState(summary) {
  assert.equal(summary.schema, LIVE2D_RENDERER_READY_REAL_EVIDENCE_REQUEST_FINAL_WAIT_STATE_SCHEMA);
  assert.equal(summary.safe_summary_only, true);
  assert.equal(summary.realEvidenceRequestStatus, "waiting_for_explicit_owner_action");
  assert.equal(summary.realEvidenceRequestSent, false);
  assert.equal(summary.realEvidenceCollectionStarted, false);
  assert.equal(summary.realRendererProbeStarted, false);
  assert.equal(summary.realRendererEvidencePresent, false);
  ...
  assert.equal(summary.motionDatasetExecutable, false);
  assert.equal(summary.motion_dataset_executable, false);
  assert.equal(summary.boundary_policy.real_evidence_request_final_wait_state_only, true);
...
function assertLive2dMotionIdentityAndComfortSpec(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_AND_COMFORT_SPEC_SCHEMA);
  assert.equal(summary.live2d_motion_identity_and_comfort_spec_status, "spec_only_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_and_comfort_spec_only_boundary, true);
  ...
  assert.equal(summary.motion_allowlist_alone_not_executable, true);
  assert.equal(summary.motion_identity_and_comfort_spec_only, true);
  assert.equal(summary.motion_allowlist_alone_is_executable_readiness, false);
  assert.equal(summary.experimental_labels_are_executable_motion, false);
  assert.equal(summary.expression_gaze_breath_body_camera_labels_are_runtime_motion, false);
  assert.equal(summary.fixture_pass_is_real_ready, false);
  assert.equal(summary.manifest_only_is_real_ready, false);
  assert.equal(summary.sse_connected_is_real_ready, false);
  assert.equal(summary.cue_accepted_is_last_cue_applied, false);
  ...
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.spec_sections, [...LIVE2D_MOTION_IDENTITY_AND_COMFORT_SPEC_SECTIONS]);
  assert.deepEqual(summary.motion_identity_profile_required_fields, [...LIVE2D_MOTION_IDENTITY_PROFILE_REQUIRED_FIELDS]);
  ...
  assert.deepEqual(summary.strong_motion_labels, [...LIVE2D_STRONG_MOTION_LABELS]);
  assert.deepEqual(summary.required_identity_comfort_rules, [...LIVE2D_MOTION_IDENTITY_AND_COMFORT_RULES]);
  assert.equal(summary.required_identity_comfort_rules.includes("strong_motion_requires_recovery"), true);
  assert.equal(summary.required_identity_comfort_rules.includes("strong_motion_requires_cooldown"), true);
  assert.equal(summary.required_identity_comfort_rules.includes("stale_cue_strong_motion_rejected_or_downgraded"), true);
  assert.equal(summary.required_identity_comfort_rules.includes("donation_relation_dependency_signal_alone_cannot_escalate_closeup_or_strong_motion"), true);
  assert.equal(summary.required_identity_comfort_rules.includes("adaptive_reaction_is_bounded_by_context_and_confidence"), true);
  assert.equal(summary.blocked_reasons.includes("motion_allowlist_alone_not_executable"), true);
  assert.equal(summary.blocked_reasons.includes("strong_motion_requires_recovery_and_cooldown"), true);
  assert.equal(summary.blocked_reasons.includes("priority1_blocked"), true);
  assert.equal(summary.blocked_reasons.includes("checked_row_count_zero"), true);
  assert.equal(summary.blocked_reasons.includes("motion_dataset_non_executable"), true);
  assert.equal(summary.blocked_reasons.includes("trusted_loader_disabled"), true);
...
function assertLive2dMotionIdentityAndComfortRejectionFixturePack(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_AND_COMFORT_REJECTION_FIXTURE_PACK_SCHEMA);
  assert.equal(summary.live2d_motion_identity_and_comfort_rejection_fixture_pack_status, "fixture_only_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_and_comfort_rejection_fixture_pack_only_boundary, true);
  assert.equal(summary.synthetic_fixture_only_boundary, true);
  assert.equal(summary.no_motion_execution_boundary, true);
  assert.equal(summary.no_runtime_allowlist_enablement_boundary, true);
  assert.equal(summary.no_renderer_ready_claim_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.motion_identity_and_comfort_rejection_fixture_pack_only, true);
  assert.equal(summary.synthetic_fixture_only, true);
  assert.equal(summary.rejected_fixture_attempts_only, true);
  assert.equal(summary.motion_allowlist_alone_is_executable_readiness, false);
  assert.equal(summary.experimental_labels_are_executable_motion, false);
  assert.equal(summary.expression_gaze_breath_body_camera_labels_are_runtime_motion, false);
  assert.equal(summary.strong_motion_without_recovery_allowed, false);
  assert.equal(summary.strong_motion_without_cooldown_allowed, false);
  assert.equal(summary.stale_cue_strong_motion_allowed, false);
  assert.equal(summary.comfort_risk_strong_motion_allowed, false);
  assert.equal(summary.subtitle_overlay_risk_strong_motion_allowed, false);
  assert.equal(summary.gaze_pressure_closeup_escalation_allowed, false);
  assert.equal(summary.donation_relation_dependency_escalation_allowed, false);
  assert.equal(summary.dependency_pressure_allowed, false);
  assert.equal(summary.voice_motion_sync_executes_motion, false);
  assert.equal(summary.adaptive_reaction_unbounded, false);
  assert.equal(summary.runtime_readiness_claimed, false);
  assert.equal(summary.production_readiness_claimed, false);
  assert.equal(summary.renderer_ready_claimed, false);
  assert.equal(summary.renderer_ready_candidate, false);
  ...
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.accepted_fixture_cases, [...LIVE2D_MOTION_IDENTITY_AND_COMFORT_ACCEPTED_FIXTURE_CASES]);
  assert.deepEqual(summary.rejected_fixture_cases, [...LIVE2D_MOTION_IDENTITY_AND_COMFORT_REJECTED_FIXTURE_CASES]);
  assert.deepEqual(summary.strong_motion_labels, [...LIVE2D_STRONG_MOTION_LABELS]);
  assert.deepEqual(summary.required_identity_comfort_rules, [...LIVE2D_MOTION_IDENTITY_AND_COMFORT_RULES]);
  for (const rejectedCase of [
    ...
    assert.equal(summary.rejected_fixture_cases.includes(rejectedCase), true, rejectedCase);
  }
  assert.equal(summary.blocked_reasons.includes("synthetic_fixture_only"), true);
  assert.equal(summary.blocked_reasons.includes("stale_or_risky_strong_motion_rejected"), true);
  assert.equal(summary.blocked_reasons.includes("priority1_blocked"), true);
  assert.equal(summary.blocked_reasons.includes("checked_row_count_zero"), true);
  assert.equal(summary.blocked_reasons.includes("motion_dataset_non_executable"), true);
  assert.equal(summary.blocked_reasons.includes("trusted_loader_disabled"), true);
...
function assertLive2dMotionIdentityAndComfortDryRunValidator(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_AND_COMFORT_DRY_RUN_VALIDATOR_SCHEMA);
  assert.equal(summary.live2d_motion_identity_and_comfort_dry_run_validator_status, "dry_run_validator_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_and_comfort_dry_run_validator_only_boundary, true);
  assert.equal(summary.synthetic_dry_run_only_boundary, true);
  assert.equal(summary.no_motion_execution_boundary, true);
  assert.equal(summary.no_runtime_allowlist_enablement_boundary, true);
  assert.equal(summary.no_renderer_ready_claim_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.motion_identity_and_comfort_dry_run_validator_only, true);
  assert.equal(summary.synthetic_dry_run_only, true);
  assert.equal(summary.dry_run_validator_executes_motion, false);
  assert.equal(summary.dry_run_validator_accepts_actual_data, false);
  assert.equal(summary.strong_motion_without_recovery_allowed, false);
  assert.equal(summary.strong_motion_without_cooldown_allowed, false);
  assert.equal(summary.stale_cue_strong_motion_allowed, false);
  assert.equal(summary.risky_strong_motion_allowed, false);
  assert.equal(summary.donation_relation_dependency_escalation_allowed, false);
  assert.equal(summary.dependency_pressure_allowed, false);
  assert.equal(summary.voice_motion_sync_executes_motion, false);
  assert.equal(summary.adaptive_reaction_unbounded, false);
  ...
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.required_input_labels, [...LIVE2D_MOTION_IDENTITY_AND_COMFORT_DRY_RUN_REQUIRED_INPUT_LABELS]);
  assert.deepEqual(summary.required_rejection_reasons, [...LIVE2D_MOTION_IDENTITY_AND_COMFORT_DRY_RUN_REJECTION_REASONS]);
  assert.deepEqual(summary.accepted_fixture_cases, [...LIVE2D_MOTION_IDENTITY_AND_COMFORT_ACCEPTED_FIXTURE_CASES]);
  assert.deepEqual(summary.rejected_fixture_cases, [...LIVE2D_MOTION_IDENTITY_AND_COMFORT_REJECTED_FIXTURE_CASES]);
  assert.deepEqual(summary.strong_motion_labels, [...LIVE2D_STRONG_MOTION_LABELS]);
  for (const rejectionReason of [
    ...
    assert.equal(summary.required_rejection_reasons.includes(rejectionReason), true, rejectionReason);
  }
  assert.equal(summary.blocked_reasons.includes("synthetic_dry_run_only"), true);
  assert.equal(summary.blocked_reasons.includes("missing_required_labels_rejected"), true);
  assert.equal(summary.blocked_reasons.includes("priority1_blocked"), true);
  assert.equal(summary.blocked_reasons.includes("checked_row_count_zero"), true);
  assert.equal(summary.blocked_reasons.includes("motion_dataset_non_executable"), true);
  assert.equal(summary.blocked_reasons.includes("trusted_loader_disabled"), true);
...
function assertLive2dMotionIdentityAndComfortRecoveryMatrix(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_AND_COMFORT_RECOVERY_MATRIX_SCHEMA);
  assert.equal(summary.live2d_motion_identity_and_comfort_recovery_matrix_status, "matrix_only_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_and_comfort_recovery_matrix_only_boundary, true);
  assert.equal(summary.no_motion_execution_boundary, true);
  assert.equal(summary.no_runtime_allowlist_enablement_boundary, true);
  assert.equal(summary.no_renderer_ready_claim_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.motion_identity_and_comfort_recovery_matrix_only, true);
  assert.equal(summary.recovery_matrix_executes_motion, false);
  assert.equal(summary.recovery_matrix_claims_runtime_ready, false);
  assert.equal(summary.strong_motion_without_recovery_allowed, false);
  assert.equal(summary.strong_motion_without_cooldown_allowed, false);
  assert.equal(summary.stale_cue_strong_motion_allowed, false);
  assert.equal(summary.risky_strong_motion_allowed, false);
  ...
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.recovery_matrix_required_fields, [...LIVE2D_MOTION_IDENTITY_AND_COMFORT_RECOVERY_MATRIX_REQUIRED_FIELDS]);
  assert.deepEqual(summary.recovery_matrix_rows, [...LIVE2D_MOTION_IDENTITY_AND_COMFORT_RECOVERY_MATRIX_ROWS]);
  assert.deepEqual(summary.recovery_matrix_blockers, [...LIVE2D_MOTION_IDENTITY_AND_COMFORT_RECOVERY_MATRIX_BLOCKERS]);
  assert.deepEqual(summary.strong_motion_labels, [...LIVE2D_STRONG_MOTION_LABELS]);
  assert.deepEqual(summary.runtime_supported_motion_styles, [...LIVE2D_RUNTIME_SUPPORTED_MOTION_STYLES]);
  for (const row of [
    ...
    assert.equal(summary.recovery_matrix_rows.includes(row), true, row);
  }
  for (const blocker of [
    ...
    assert.equal(summary.recovery_matrix_blockers.includes(blocker), true, blocker);
  }
  assert.equal(summary.blocked_reasons.includes("strong_motion_requires_recovery_and_cooldown"), true);
  assert.equal(summary.blocked_reasons.includes("risk_downgrade_motion_required"), true);
  assert.equal(summary.blocked_reasons.includes("priority1_blocked"), true);
  assert.equal(summary.blocked_reasons.includes("checked_row_count_zero"), true);
  assert.equal(summary.blocked_reasons.includes("motion_dataset_non_executable"), true);
  assert.equal(summary.blocked_reasons.includes("trusted_loader_disabled"), true);
...
function assertLive2dMotionIdentityAndComfortContextGate(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_AND_COMFORT_CONTEXT_GATE_SCHEMA);
  assert.equal(summary.live2d_motion_identity_and_comfort_context_gate_status, "context_gate_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_and_comfort_context_gate_only_boundary, true);
  assert.equal(summary.context_gate_planning_only_boundary, true);
  assert.equal(summary.no_motion_execution_boundary, true);
  assert.equal(summary.no_runtime_allowlist_enablement_boundary, true);
  assert.equal(summary.no_renderer_ready_claim_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.motion_identity_and_comfort_context_gate_only, true);
  assert.equal(summary.context_gate_executes_motion, false);
  assert.equal(summary.context_gate_claims_runtime_ready, false);
  assert.equal(summary.stale_context_strong_motion_allowed, false);
  assert.equal(summary.low_confidence_strong_motion_allowed, false);
  assert.equal(summary.viewer_comfort_risk_strong_motion_allowed, false);
  assert.equal(summary.subtitle_visibility_risk_strong_motion_allowed, false);
  assert.equal(summary.camera_proximity_risk_strong_motion_allowed, false);
  assert.equal(summary.donation_relation_dependency_only_escalation_allowed, false);
  assert.equal(summary.dependency_pressure_allowed, false);
  assert.equal(summary.runtime_readiness_claimed, false);
  assert.equal(summary.production_readiness_claimed, false);
  assert.equal(summary.renderer_ready_claimed, false);
  ...
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.required_context_gate_labels, [...LIVE2D_MOTION_IDENTITY_AND_COMFORT_CONTEXT_GATE_REQUIRED_LABELS]);
  assert.deepEqual(summary.required_context_gate_rejections, [...LIVE2D_MOTION_IDENTITY_AND_COMFORT_CONTEXT_GATE_REJECTIONS]);
  assert.deepEqual(summary.strong_motion_labels, [...LIVE2D_STRONG_MOTION_LABELS]);
  assert.deepEqual(summary.runtime_supported_motion_styles, [...LIVE2D_RUNTIME_SUPPORTED_MOTION_STYLES]);
  for (const rejection of [
    ...
    assert.equal(summary.required_context_gate_rejections.includes(rejection), true, rejection);
  }
  assert.equal(summary.blocked_reasons.includes("context_freshness_required"), true);
  assert.equal(summary.blocked_reasons.includes("confidence_required"), true);
  assert.equal(summary.blocked_reasons.includes("risk_downgrade_motion_required"), true);
  assert.equal(summary.blocked_reasons.includes("priority1_blocked"), true);
  assert.equal(summary.blocked_reasons.includes("checked_row_count_zero"), true);
  assert.equal(summary.blocked_reasons.includes("motion_dataset_non_executable"), true);
...
function assertLive2dMotionIdentityAndComfortSubtitleGazeGuard(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_AND_COMFORT_SUBTITLE_GAZE_GUARD_SCHEMA);
  assert.equal(summary.live2d_motion_identity_and_comfort_subtitle_gaze_guard_status, "subtitle_gaze_guard_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_and_comfort_subtitle_gaze_guard_only_boundary, true);
  assert.equal(summary.subtitle_gaze_guard_planning_only_boundary, true);
  assert.equal(summary.no_motion_execution_boundary, true);
  assert.equal(summary.no_runtime_allowlist_enablement_boundary, true);
  assert.equal(summary.no_renderer_ready_claim_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.motion_identity_and_comfort_subtitle_gaze_guard_only, true);
  assert.equal(summary.subtitle_gaze_guard_executes_motion, false);
  assert.equal(summary.subtitle_gaze_guard_claims_runtime_ready, false);
  assert.equal(summary.subtitle_overlay_risk_strong_motion_allowed, false);
  assert.equal(summary.subtitle_overlay_risk_closeup_allowed, false);
  assert.equal(summary.gaze_pressure_risk_strong_motion_allowed, false);
  assert.equal(summary.gaze_pressure_risk_closeup_allowed, false);
  assert.equal(summary.camera_proximity_risk_strong_motion_allowed, false);
  assert.equal(summary.camera_proximity_risk_closeup_allowed, false);
  assert.equal(summary.runtime_readiness_claimed, false);
  assert.equal(summary.production_readiness_claimed, false);
  assert.equal(summary.renderer_ready_claimed, false);
  assert.equal(summary.renderer_ready_candidate, false);
  ...
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.required_subtitle_gaze_labels, [...LIVE2D_MOTION_IDENTITY_AND_COMFORT_SUBTITLE_GAZE_REQUIRED_LABELS]);
  assert.deepEqual(summary.required_subtitle_gaze_rejections, [...LIVE2D_MOTION_IDENTITY_AND_COMFORT_SUBTITLE_GAZE_REJECTIONS]);
  assert.deepEqual(summary.strong_motion_labels, [...LIVE2D_STRONG_MOTION_LABELS]);
  assert.deepEqual(summary.runtime_supported_motion_styles, [...LIVE2D_RUNTIME_SUPPORTED_MOTION_STYLES]);
  for (const rejection of [
    ...
    assert.equal(summary.required_subtitle_gaze_rejections.includes(rejection), true, rejection);
  }
  assert.equal(summary.blocked_reasons.includes("subtitle_overlay_risk_requires_downgrade"), true);
  assert.equal(summary.blocked_reasons.includes("gaze_pressure_risk_requires_downgrade"), true);
  assert.equal(summary.blocked_reasons.includes("camera_proximity_risk_requires_downgrade"), true);
  assert.equal(summary.blocked_reasons.includes("priority1_blocked"), true);
  assert.equal(summary.blocked_reasons.includes("checked_row_count_zero"), true);
  assert.equal(summary.blocked_reasons.includes("motion_dataset_non_executable"), true);
  assert.equal(summary.blocked_reasons.includes("trusted_loader_disabled"), true);
...
function assertLive2dMotionIdentityAndComfortPersonaPressureGuard(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_AND_COMFORT_PERSONA_PRESSURE_GUARD_SCHEMA);
  assert.equal(summary.live2d_motion_identity_and_comfort_persona_pressure_guard_status, "persona_pressure_guard_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_and_comfort_persona_pressure_guard_only_boundary, true);
  assert.equal(summary.persona_pressure_guard_planning_only_boundary, true);
  assert.equal(summary.no_motion_execution_boundary, true);
  assert.equal(summary.no_runtime_allowlist_enablement_boundary, true);
  assert.equal(summary.no_renderer_ready_claim_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.motion_identity_and_comfort_persona_pressure_guard_only, true);
  assert.equal(summary.persona_pressure_guard_executes_motion, false);
  assert.equal(summary.persona_pressure_guard_claims_runtime_ready, false);
  assert.equal(summary.donation_signal_escalates_strong_motion_allowed, false);
  assert.equal(summary.relation_signal_escalates_strong_motion_allowed, false);
  assert.equal(summary.dependency_signal_escalates_strong_motion_allowed, false);
  assert.equal(summary.dependency_pressure_allowed, false);
  assert.equal(summary.persona_fit_claims_relationship_commitment_allowed, false);
  assert.equal(summary.runtime_readiness_claimed, false);
  assert.equal(summary.production_readiness_claimed, false);
  assert.equal(summary.renderer_ready_claimed, false);
  assert.equal(summary.renderer_ready_candidate, false);
  ...
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.required_persona_pressure_labels, [...LIVE2D_MOTION_IDENTITY_AND_COMFORT_PERSONA_PRESSURE_REQUIRED_LABELS]);
  assert.deepEqual(summary.required_persona_pressure_rejections, [...LIVE2D_MOTION_IDENTITY_AND_COMFORT_PERSONA_PRESSURE_REJECTIONS]);
  assert.deepEqual(summary.strong_motion_labels, [...LIVE2D_STRONG_MOTION_LABELS]);
  assert.deepEqual(summary.runtime_supported_motion_styles, [...LIVE2D_RUNTIME_SUPPORTED_MOTION_STYLES]);
  for (const rejection of [
    ...
    assert.equal(summary.required_persona_pressure_rejections.includes(rejection), true, rejection);
  }
  assert.equal(summary.blocked_reasons.includes("persona_pressure_escalation_rejected"), true);
  assert.equal(summary.blocked_reasons.includes("dependency_pressure_rejected"), true);
  assert.equal(summary.blocked_reasons.includes("safe_downgrade_motion_required"), true);
  assert.equal(summary.blocked_reasons.includes("priority1_blocked"), true);
  assert.equal(summary.blocked_reasons.includes("checked_row_count_zero"), true);
  assert.equal(summary.blocked_reasons.includes("motion_dataset_non_executable"), true);
  assert.equal(summary.blocked_reasons.includes("trusted_loader_disabled"), true);
...
function assertLive2dMotionIdentityAndComfortVoiceSyncHintBoundary(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_AND_COMFORT_VOICE_SYNC_HINT_BOUNDARY_SCHEMA);
  assert.equal(summary.live2d_motion_identity_and_comfort_voice_sync_hint_boundary_status, "voice_sync_hint_boundary_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_and_comfort_voice_sync_hint_boundary_only_boundary, true);
  assert.equal(summary.voice_sync_hint_planning_only_boundary, true);
  assert.equal(summary.no_motion_execution_boundary, true);
  assert.equal(summary.no_cue_application_boundary, true);
  assert.equal(summary.no_audio_runtime_execution_boundary, true);
  assert.equal(summary.no_tts_runtime_execution_boundary, true);
  assert.equal(summary.no_external_service_boundary, true);
  assert.equal(summary.no_runtime_allowlist_enablement_boundary, true);
  assert.equal(summary.no_renderer_ready_claim_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.motion_identity_and_comfort_voice_sync_hint_boundary_only, true);
  assert.equal(summary.voice_sync_hint_executes_motion, false);
  assert.equal(summary.voice_timing_hint_applies_cue, false);
  assert.equal(summary.voice_sync_hint_claims_runtime_ready, false);
  assert.equal(summary.audio_runtime_execution_allowed, false);
  assert.equal(summary.tts_runtime_execution_allowed, false);
  assert.equal(summary.external_service_allowed, false);
  assert.equal(summary.runtime_readiness_claimed, false);
  assert.equal(summary.production_readiness_claimed, false);
  assert.equal(summary.renderer_ready_claimed, false);
  assert.equal(summary.renderer_ready_candidate, false);
  ...
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.required_voice_sync_hint_labels, [...LIVE2D_MOTION_IDENTITY_AND_COMFORT_VOICE_SYNC_HINT_REQUIRED_LABELS]);
  assert.deepEqual(summary.required_voice_sync_hint_rejections, [...LIVE2D_MOTION_IDENTITY_AND_COMFORT_VOICE_SYNC_HINT_REJECTIONS]);
  assert.deepEqual(summary.strong_motion_labels, [...LIVE2D_STRONG_MOTION_LABELS]);
  assert.deepEqual(summary.runtime_supported_motion_styles, [...LIVE2D_RUNTIME_SUPPORTED_MOTION_STYLES]);
  for (const rejection of [
    ...
    assert.equal(summary.required_voice_sync_hint_rejections.includes(rejection), true, rejection);
  }
  assert.equal(summary.blocked_reasons.includes("voice_sync_hint_not_executable"), true);
  assert.equal(summary.blocked_reasons.includes("voice_timing_hint_no_cue_application"), true);
  assert.equal(summary.blocked_reasons.includes("audio_runtime_execution_blocked"), true);
  assert.equal(summary.blocked_reasons.includes("tts_runtime_execution_blocked"), true);
  assert.equal(summary.blocked_reasons.includes("external_service_blocked"), true);
  assert.equal(summary.blocked_reasons.includes("priority1_blocked"), true);
  assert.equal(summary.blocked_reasons.includes("checked_row_count_zero"), true);
  assert.equal(summary.blocked_reasons.includes("motion_dataset_non_executable"), true);
  assert.equal(summary.blocked_reasons.includes("trusted_loader_disabled"), true);
...
function assertLive2dMotionIdentityAndComfortAdaptiveBounds(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_AND_COMFORT_ADAPTIVE_BOUNDS_SCHEMA);
  assert.equal(summary.live2d_motion_identity_and_comfort_adaptive_bounds_status, "adaptive_bounds_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_and_comfort_adaptive_bounds_only_boundary, true);
  assert.equal(summary.adaptive_bounds_planning_only_boundary, true);
  assert.equal(summary.no_motion_execution_boundary, true);
  assert.equal(summary.no_cue_application_boundary, true);
  assert.equal(summary.no_runtime_allowlist_enablement_boundary, true);
  assert.equal(summary.no_renderer_ready_claim_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.motion_identity_and_comfort_adaptive_bounds_only, true);
  assert.equal(summary.adaptive_bounds_executes_motion, false);
  assert.equal(summary.adaptive_bounds_claims_runtime_ready, false);
  assert.equal(summary.adaptive_reaction_unbounded, false);
  assert.equal(summary.repeated_strong_motion_allowed, false);
  assert.equal(summary.low_confidence_escalation_allowed, false);
  assert.equal(summary.stale_context_escalation_allowed, false);
  assert.equal(summary.comfort_risk_escalation_allowed, false);
  assert.equal(summary.serious_focus_playful_motion_allowed, false);
  assert.equal(summary.moderation_limited_personalized_strong_motion_allowed, false);
  assert.equal(summary.crisis_signal_closeup_allowed, false);
  assert.equal(summary.minor_signal_closeup_allowed, false);
  assert.equal(summary.romantic_pressure_closeup_allowed, false);
  assert.equal(summary.dependency_pressure_strong_motion_allowed, false);
  assert.equal(summary.donation_amount_escalates_motion_allowed, false);
  assert.equal(summary.relationship_score_escalates_proximity_allowed, false);
  assert.equal(summary.experimental_motion_labels_executable, false);
  assert.equal(summary.runtime_readiness_claimed, false);
  assert.equal(summary.production_readiness_claimed, false);
  assert.equal(summary.renderer_ready_claimed, false);
  assert.equal(summary.renderer_ready_candidate, false);
  ...
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.required_adaptive_bounds_labels, [...LIVE2D_MOTION_IDENTITY_AND_COMFORT_ADAPTIVE_BOUNDS_REQUIRED_LABELS]);
  assert.deepEqual(summary.required_adaptive_bounds_rejections, [...LIVE2D_MOTION_IDENTITY_AND_COMFORT_ADAPTIVE_BOUNDS_REJECTIONS]);
  assert.deepEqual(summary.strong_motion_labels, [...LIVE2D_STRONG_MOTION_LABELS]);
  assert.deepEqual(summary.runtime_supported_motion_styles, [...LIVE2D_RUNTIME_SUPPORTED_MOTION_STYLES]);
  for (const rejection of [
    ...
    assert.equal(summary.required_adaptive_bounds_rejections.includes(rejection), true, rejection);
  }
  assert.equal(summary.blocked_reasons.includes("adaptive_reaction_must_be_bounded"), true);
  assert.equal(summary.blocked_reasons.includes("repeated_strong_motion_requires_cooldown"), true);
  assert.equal(summary.blocked_reasons.includes("low_confidence_requires_downgrade"), true);
  assert.equal(summary.blocked_reasons.includes("stale_context_requires_downgrade"), true);
  assert.equal(summary.blocked_reasons.includes("comfort_risk_requires_downgrade"), true);
  assert.equal(summary.blocked_reasons.includes("serious_focus_requires_downgrade"), true);
  assert.equal(summary.blocked_reasons.includes("moderation_boundary_requires_safe_motion"), true);
  assert.equal(summary.blocked_reasons.includes("crisis_minor_romantic_dependency_closeup_rejected"), true);
  assert.equal(summary.blocked_reasons.includes("donation_relation_escalation_rejected"), true);
  assert.equal(summary.blocked_reasons.includes("experimental_motion_non_executable"), true);
  assert.equal(summary.blocked_reasons.includes("priority1_blocked"), true);
  assert.equal(summary.blocked_reasons.includes("checked_row_count_zero"), true);
  assert.equal(summary.blocked_reasons.includes("motion_dataset_non_executable"), true);
  assert.equal(summary.blocked_reasons.includes("trusted_loader_disabled"), true);
...
function assertLive2dMotionIdentityComfortDevelopmentSchedule(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_COMFORT_DEVELOPMENT_SCHEDULE_SCHEMA);
  assert.equal(summary.live2d_motion_identity_comfort_development_schedule_status, "development_schedule_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_development_schedule_only_boundary, true);
  assert.equal(summary.schedule_planning_only_boundary, true);
  assert.equal(summary.no_motion_execution_boundary, true);
  ...
  assert.equal(summary.no_renderer_ready_claim_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.motion_identity_comfort_development_schedule_only, true);
  assert.equal(summary.schedule_executes_motion, false);
  assert.equal(summary.schedule_claims_runtime_ready, false);
  assert.equal(summary.schedule_claims_production_ready, false);
  assert.equal(summary.schedule_creates_owner_confirmation, false);
  assert.equal(summary.future_real_renderer_evidence_phase_started, false);
  assert.equal(summary.future_actual_renderer_probe_phase_started, false);
  assert.equal(summary.future_trusted_loader_phase_started, false);
  assert.equal(summary.runtime_readiness_claimed, false);
  assert.equal(summary.production_readiness_claimed, false);
  assert.equal(summary.renderer_ready_claimed, false);
  assert.equal(summary.renderer_ready_candidate, false);
  ...
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.motion_identity_comfort_development_schedule_phases, [...LIVE2D_MOTION_IDENTITY_COMFORT_DEVELOPMENT_SCHEDULE_PHASES]);
  assert.deepEqual(summary.motion_identity_comfort_development_schedule_boundaries, [...LIVE2D_MOTION_IDENTITY_COMFORT_DEVELOPMENT_SCHEDULE_BOUNDARIES]);
  assert.equal(summary.motion_identity_comfort_development_schedule_phases.includes("future_real_renderer_evidence_phase_owner_action_only"), true);
  assert.equal(summary.motion_identity_comfort_development_schedule_phases.includes("future_actual_renderer_probe_phase_owner_confirmation_only"), true);
  assert.equal(summary.motion_identity_comfort_development_schedule_phases.includes("future_trusted_loader_phase_owner_confirmation_and_real_evidence_only"), true);
  assert.equal(summary.blocked_reasons.includes("schedule_is_not_readiness"), true);
  assert.equal(summary.blocked_reasons.includes("schedule_is_not_execution"), true);
  assert.equal(summary.blocked_reasons.includes("future_real_renderer_evidence_requires_owner_action"), true);
  assert.equal(summary.blocked_reasons.includes("future_actual_renderer_probe_requires_owner_confirmation"), true);
  assert.equal(summary.blocked_reasons.includes("future_trusted_loader_requires_owner_confirmation_and_real_evidence"), true);
  assert.equal(summary.blocked_reasons.includes("priority1_blocked"), true);
  assert.equal(summary.blocked_reasons.includes("checked_row_count_zero"), true);
  assert.equal(summary.blocked_reasons.includes("motion_dataset_non_executable"), true);
  assert.equal(summary.blocked_reasons.includes("trusted_loader_disabled"), true);
...
function assertLive2dMotionIdentityComfortCompletionReview(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_COMFORT_COMPLETION_REVIEW_SCHEMA);
  assert.equal(summary.live2d_motion_identity_comfort_completion_review_status, "completion_review_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_completion_review_only_boundary, true);
  assert.equal(summary.completion_review_is_not_readiness_boundary, true);
  assert.equal(summary.completion_review_is_not_execution_boundary, true);
  assert.equal(summary.no_renderer_probe_boundary, true);
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_trusted_loader_enablement_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.no_priority1_resolution_boundary, true);
  assert.equal(summary.motion_identity_comfort_completion_review_only, true);
  assert.equal(summary.completion_review_claims_runtime_ready, false);
  assert.equal(summary.completion_review_claims_production_ready, false);
  assert.equal(summary.completion_review_creates_owner_confirmation, false);
  assert.equal(summary.completion_review_starts_actual_renderer_probe, false);
  assert.equal(summary.completion_review_accepts_actual_data, false);
  assert.equal(summary.runtime_readiness_claimed, false);
  assert.equal(summary.production_readiness_claimed, false);
  assert.equal(summary.renderer_ready_claimed, false);
  assert.equal(summary.renderer_ready_candidate, false);
  ...
  assert.equal(summary.trusted_loader_allowlist_enabled, false);
  assert.equal(summary.actual_ingestion_allowed, false);
  assert.equal(summary.priority1_resolved, false);
  assert.equal(summary.checked_row_count, 0);
  assert.equal(summary.motion_dataset_executable, false);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.motion_identity_comfort_completed_safe_items, [...LIVE2D_MOTION_IDENTITY_COMFORT_COMPLETION_REVIEW_COMPLETED_ITEMS]);
  assert.deepEqual(summary.motion_identity_comfort_open_blockers, [...LIVE2D_MOTION_IDENTITY_COMFORT_COMPLETION_REVIEW_OPEN_BLOCKERS]);
  assert.deepEqual(summary.motion_identity_comfort_completion_review_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_COMPLETION_REVIEW_REJECTIONS]);
  for (const blocker of [
    ...
    assert.equal(summary.motion_identity_comfort_open_blockers.includes(blocker), true, blocker);
  ...
  for (const rejection of [
    ...
    assert.equal(summary.motion_identity_comfort_completion_review_rejections.includes(rejection), true, rejection);
  }
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
...
function assertLive2dMotionIdentityProfileStatusSurface(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_PROFILE_STATUS_SURFACE_SCHEMA);
  assert.equal(summary.live2d_motion_identity_profile_status_surface_status, "identity_profile_status_surface_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_profile_status_surface_only_boundary, true);
  assert.equal(summary.safe_labels_only_boundary, true);
  assert.equal(summary.no_motion_execution_boundary, true);
  assert.equal(summary.no_renderer_material_boundary, true);
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_trusted_loader_enablement_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_identity_profile_status_surface_only, true);
  assert.equal(summary.identity_profile_present, true);
  assert.equal(summary.safe_labels_only, true);
  assert.equal(summary.identity_profile_executes_motion, false);
  assert.equal(summary.identity_profile_claims_runtime_ready, false);
  assert.equal(summary.identity_profile_claims_production_ready, false);
  assert.equal(summary.experimental_labels_executable, false);
  assert.equal(summary.runtime_readiness_claimed, false);
  assert.equal(summary.production_readiness_claimed, false);
  assert.equal(summary.renderer_ready_claimed, false);
  assert.equal(summary.renderer_ready_candidate, false);
  ...
  assert.equal(summary.motion_dataset_executable, false);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.motion_identity_profile_status_safe_labels, [...LIVE2D_MOTION_IDENTITY_PROFILE_STATUS_SAFE_LABELS]);
  assert.deepEqual(summary.motion_identity_profile_status_rejections, [...LIVE2D_MOTION_IDENTITY_PROFILE_STATUS_REJECTIONS]);
  assert.deepEqual(summary.runtime_supported_motion_styles, [...LIVE2D_RUNTIME_SUPPORTED_MOTION_STYLES]);
  assert.deepEqual(summary.experimental_motion_labels, [...LIVE2D_EXPERIMENTAL_MOTION_LABELS]);
  assert.equal(summary.experimental_motion_labels.includes("blink_attention"), true);
  assert.equal(summary.blocked_reasons.includes("identity_profile_is_not_execution"), true);
  assert.equal(summary.blocked_reasons.includes("identity_profile_is_not_readiness"), true);
  assert.equal(summary.blocked_reasons.includes("experimental_labels_non_executable"), true);
  assert.equal(summary.blocked_reasons.includes("priority1_blocked"), true);
  assert.equal(summary.blocked_reasons.includes("checked_row_count_zero"), true);
  assert.equal(summary.blocked_reasons.includes("motion_dataset_non_executable"), true);
  assert.equal(summary.blocked_reasons.includes("trusted_loader_disabled"), true);
  for (const rejection of [
    ...
    assert.equal(summary.motion_identity_profile_status_rejections.includes(rejection), true, rejection);
  }
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
...
function assertLive2dMotionComfortPolicyStatusSurface(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_COMFORT_POLICY_STATUS_SURFACE_SCHEMA);
  assert.equal(summary.live2d_motion_comfort_policy_status_surface_status, "comfort_policy_status_surface_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_comfort_policy_status_surface_only_boundary, true);
  assert.equal(summary.comfort_policy_is_not_execution_boundary, true);
  assert.equal(summary.strong_motion_not_executable_by_policy_boundary, true);
  assert.equal(summary.no_renderer_probe_boundary, true);
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_trusted_loader_enablement_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_comfort_policy_status_surface_only, true);
  assert.equal(summary.comfort_policy_present, true);
  assert.equal(summary.comfort_policy_executes_motion, false);
  assert.equal(summary.comfort_policy_marks_strong_motion_ready, false);
  assert.equal(summary.viewer_comfort_mode_downgrades_strong_motion, true);
  assert.equal(summary.cooldown_required_for_strong_motion, true);
  assert.equal(summary.fatigue_risk_downgrades_strong_motion, true);
  assert.equal(summary.photosensitivity_risk_downgrades_strong_motion, true);
  assert.equal(summary.subtitle_gaze_camera_risk_downgrades_strong_motion, true);
  assert.equal(summary.runtime_readiness_claimed, false);
  assert.equal(summary.production_readiness_claimed, false);
  assert.equal(summary.renderer_ready_claimed, false);
  assert.equal(summary.renderer_ready_candidate, false);
  ...
  assert.equal(summary.motion_dataset_executable, false);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.motion_comfort_policy_status_labels, [...LIVE2D_MOTION_COMFORT_POLICY_STATUS_LABELS]);
  assert.deepEqual(summary.motion_comfort_policy_status_rejections, [...LIVE2D_MOTION_COMFORT_POLICY_STATUS_REJECTIONS]);
  assert.deepEqual(summary.strong_motion_labels, [...LIVE2D_STRONG_MOTION_LABELS]);
  for (const blocker of [
  ...
  assert.equal(summary.motion_comfort_policy_status_rejections.includes("comfort_policy_marks_strong_motion_ready"), true);
  assert.equal(summary.motion_comfort_policy_status_rejections.includes("comfort_policy_claims_runtime_ready"), true);
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
function assertLive2dMotionFreshnessPolicyCrossSurfaceConsistency(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_FRESHNESS_POLICY_CROSS_SURFACE_CONSISTENCY_SCHEMA);
  assert.equal(summary.live2d_motion_freshness_policy_cross_surface_consistency_status, "freshness_policy_cross_surface_consistency_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_freshness_policy_cross_surface_consistency_only_boundary, true);
  ...
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_freshness_policy_cross_surface_consistency_only, true);
  assert.equal(summary.stale_cue_strong_motion_rejected_across_surfaces, true);
  assert.equal(summary.safe_downgrade_same_meaning_across_surfaces, true);
  assert.equal(summary.freshness_policy_executes_motion, false);
  assert.equal(summary.freshness_policy_applies_cue, false);
  assert.equal(summary.freshness_policy_claims_runtime_ready, false);
  assert.equal(summary.freshness_policy_claims_production_ready, false);
  assert.equal(summary.runtime_readiness_claimed, false);
  assert.equal(summary.production_readiness_claimed, false);
  assert.equal(summary.renderer_ready_claimed, false);
  assert.equal(summary.renderer_ready_candidate, false);
  ...
  assert.equal(summary.motion_dataset_executable, false);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.freshness_policy_surfaces, [...LIVE2D_MOTION_FRESHNESS_POLICY_SURFACES]);
  assert.deepEqual(summary.freshness_policy_rejections, [...LIVE2D_MOTION_FRESHNESS_POLICY_REJECTIONS]);
  assert.deepEqual(summary.strong_motion_labels, [...LIVE2D_STRONG_MOTION_LABELS]);
  for (const blocker of [
  ...
  assert.equal(summary.freshness_policy_rejections.includes("stale_cue_strong_motion_selected"), true);
  assert.equal(summary.freshness_policy_rejections.includes("freshness_policy_mismatch_between_surfaces"), true);
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
function assertLive2dMotionStrongMotionUnsafeOverrideRejection(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_STRONG_MOTION_UNSAFE_OVERRIDE_REJECTION_SCHEMA);
  assert.equal(summary.live2d_motion_strong_motion_unsafe_override_rejection_status, "strong_motion_unsafe_override_rejected");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.strong_motion_unsafe_override_rejection_only_boundary, true);
  assert.equal(summary.no_motion_execution_boundary, true);
  assert.equal(summary.no_cue_application_boundary, true);
  assert.equal(summary.no_renderer_probe_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  ...
  assert.equal(summary.no_trusted_loader_enablement_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.strong_motion_unsafe_override_rejection_only, true);
  assert.equal(summary.surprise_scream_executable, false);
  assert.equal(summary.happy_dance_executable, false);
  assert.equal(summary.laugh_big_recovery_required, true);
  assert.equal(summary.happy_loud_sing_cooldown_required, true);
  assert.equal(summary.strong_motion_ready, false);
  assert.equal(summary.strong_motion_downgraded_or_rejected, true);
  assert.equal(summary.runtime_readiness_claimed, false);
  assert.equal(summary.production_readiness_claimed, false);
  assert.equal(summary.renderer_ready_claimed, false);
  assert.equal(summary.renderer_ready_candidate, false);
  ...
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.strong_motion_labels, [...LIVE2D_STRONG_MOTION_LABELS]);
  assert.deepEqual(summary.strong_motion_unsafe_override_rejections, [...LIVE2D_MOTION_STRONG_MOTION_UNSAFE_OVERRIDE_REJECTIONS]);
  for (const blocker of [
  ...
  assert.equal(summary.strong_motion_unsafe_override_rejections.includes("surprise_scream_executable_override"), true);
  assert.equal(summary.strong_motion_unsafe_override_rejections.includes("happy_dance_executable_override"), true);
  assert.equal(summary.strong_motion_unsafe_override_rejections.includes("strong_motion_ready_true"), true);
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
function assertLive2dMotionIdentityComfortNoSweeteningSweep(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_COMFORT_NO_SWEETENING_SWEEP_SCHEMA);
  assert.equal(summary.live2d_motion_identity_comfort_no_sweetening_sweep_status, "no_sweetening_sweep_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_no_sweetening_sweep_only_boundary, true);
  assert.equal(summary.no_readiness_sweetening_boundary, true);
  assert.equal(summary.no_motion_execution_boundary, true);
  assert.equal(summary.no_runtime_motion_executable_boundary, true);
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.no_trusted_loader_enablement_boundary, true);
  assert.equal(summary.motion_identity_comfort_no_sweetening_sweep_only, true);
  assert.equal(summary.spec_completion_is_runtime_readiness, false);
  assert.equal(summary.fixture_pass_is_runtime_readiness, false);
  assert.equal(summary.dry_run_pass_is_runtime_readiness, false);
  assert.equal(summary.schedule_update_is_runtime_readiness, false);
  assert.equal(summary.completion_review_is_runtime_readiness, false);
  assert.equal(summary.status_surface_executes_motion, false);
  assert.equal(summary.experimental_labels_executable, false);
  assert.equal(summary.runtime_motion_executable, false);
  assert.equal(summary.strong_motion_ready, false);
  assert.equal(summary.runtime_readiness_claimed, false);
  assert.equal(summary.production_readiness_claimed, false);
  assert.equal(summary.renderer_ready_claimed, false);
  ...
  assert.equal(summary.motion_dataset_executable, false);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.no_sweetening_inputs, [...LIVE2D_MOTION_IDENTITY_COMFORT_NO_SWEETENING_SWEEP_INPUTS]);
  assert.deepEqual(summary.no_sweetening_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_NO_SWEETENING_SWEEP_REJECTIONS]);
  for (const blocker of [
  ...
  assert.equal(summary.no_sweetening_rejections.includes("runtime_motion_marked_executable"), true);
  assert.equal(summary.no_sweetening_rejections.includes("strong_motion_marked_ready"), true);
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
function assertLive2dMotionIdentityComfortImplementationGapAudit(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_COMFORT_IMPLEMENTATION_GAP_AUDIT_SCHEMA);
  assert.equal(summary.live2d_motion_identity_comfort_implementation_gap_audit_status, "implementation_gap_audit_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_implementation_gap_audit_only_boundary, true);
  assert.equal(summary.safe_gap_summary_only_boundary, true);
  ...
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_identity_comfort_implementation_gap_audit_only, true);
  assert.equal(summary.gap_audit_executes_renderer, false);
  assert.equal(summary.gap_audit_applies_cue, false);
  assert.equal(summary.gap_audit_loads_model, false);
  assert.equal(summary.gap_audit_loads_scene, false);
  assert.equal(summary.gap_audit_claims_runtime_ready, false);
  assert.equal(summary.gap_audit_claims_production_ready, false);
  assert.equal(summary.runtime_readiness_claimed, false);
  assert.equal(summary.production_readiness_claimed, false);
  assert.equal(summary.renderer_ready_claimed, false);
  assert.equal(summary.renderer_ready_candidate, false);
  ...
  assert.equal(summary.motion_dataset_executable, false);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.implementation_gap_audit_items, [...LIVE2D_MOTION_IDENTITY_COMFORT_IMPLEMENTATION_GAP_AUDIT_ITEMS]);
  assert.deepEqual(summary.implementation_gap_audit_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_IMPLEMENTATION_GAP_AUDIT_REJECTIONS]);
  for (const blocker of [
  ...
  assert.equal(summary.implementation_gap_audit_rejections.includes("gap_audit_executes_renderer"), true);
  assert.equal(summary.implementation_gap_audit_rejections.includes("gap_audit_applies_cue"), true);
  assert.equal(summary.implementation_gap_audit_rejections.includes("gap_audit_claims_runtime_ready"), true);
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
function assertLive2dMotionIdentityComfortImplementationGapRegister(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_COMFORT_IMPLEMENTATION_GAP_REGISTER_SCHEMA);
  assert.equal(summary.live2d_motion_identity_comfort_implementation_gap_register_status, "implementation_gap_register_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_implementation_gap_register_only_boundary, true);
  ...
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_identity_comfort_implementation_gap_register_only, true);
  assert.equal(summary.safe_gap_register_only, true);
  assert.equal(summary.gap_register_executes_renderer, false);
  assert.equal(summary.gap_register_applies_cue, false);
  assert.equal(summary.gap_register_loads_model, false);
  assert.equal(summary.gap_register_loads_scene, false);
  assert.equal(summary.gap_register_claims_runtime_ready, false);
  assert.equal(summary.gap_register_claims_production_ready, false);
  assert.equal(summary.runtime_readiness_claimed, false);
  assert.equal(summary.production_readiness_claimed, false);
  assert.equal(summary.renderer_ready_claimed, false);
  assert.equal(summary.renderer_ready_candidate, false);
  ...
  assert.equal(summary.motion_dataset_executable, false);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.implementation_gap_register_categories, [...LIVE2D_MOTION_IDENTITY_COMFORT_IMPLEMENTATION_GAP_REGISTER_CATEGORIES]);
  assert.deepEqual(summary.implementation_gap_register_actions, [...LIVE2D_MOTION_IDENTITY_COMFORT_IMPLEMENTATION_GAP_REGISTER_ACTIONS]);
  assert.deepEqual(summary.implementation_gap_register_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_IMPLEMENTATION_GAP_REGISTER_REJECTIONS]);
  for (const blocker of [
  ...
  assert.equal(summary.implementation_gap_register_categories.includes("renderer_evidence_gap"), true);
  assert.equal(summary.implementation_gap_register_actions.includes("keep_readiness_claims_false"), true);
  assert.equal(summary.implementation_gap_register_rejections.includes("gap_register_executes_renderer"), true);
  assert.equal(summary.implementation_gap_register_rejections.includes("gap_register_claims_runtime_ready"), true);
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
function assertLive2dMotionIdentityComfortFinalLongContinuationReview2(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_COMFORT_FINAL_LONG_CONTINUATION_REVIEW2_SCHEMA);
  assert.equal(summary.live2d_motion_identity_comfort_final_long_continuation_review2_status, "final_long_continuation_review2_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_final_long_continuation_review2_only_boundary, true);
  assert.equal(summary.safe_review_summary_only_boundary, true);
  assert.equal(summary.no_renderer_execution_boundary, true);
  assert.equal(summary.no_cue_application_boundary, true);
  assert.equal(summary.no_model_scene_load_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_identity_comfort_final_long_continuation_review2_only, true);
  assert.equal(summary.safe_review_summary_only, true);
  assert.equal(summary.review2_executes_renderer, false);
  assert.equal(summary.review2_applies_cue, false);
  assert.equal(summary.review2_loads_model, false);
  assert.equal(summary.review2_loads_scene, false);
  assert.equal(summary.review2_claims_runtime_ready, false);
  assert.equal(summary.review2_claims_production_ready, false);
  assert.equal(summary.runtime_readiness_claimed, false);
  assert.equal(summary.production_readiness_claimed, false);
  assert.equal(summary.renderer_ready_claimed, false);
  assert.equal(summary.renderer_ready_candidate, false);
  ...
  assert.equal(summary.motion_dataset_executable, false);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.final_long_continuation_review2_completed_items, [...LIVE2D_MOTION_IDENTITY_COMFORT_FINAL_LONG_CONTINUATION_REVIEW2_COMPLETED_ITEMS]);
  assert.deepEqual(summary.final_long_continuation_review2_open_blockers, [...LIVE2D_MOTION_IDENTITY_COMFORT_FINAL_LONG_CONTINUATION_REVIEW2_OPEN_BLOCKERS]);
  assert.deepEqual(summary.final_long_continuation_review2_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_FINAL_LONG_CONTINUATION_REVIEW2_REJECTIONS]);
  for (const blocker of [
  ...
  assert.equal(summary.final_long_continuation_review2_completed_items.includes("implementation_gap_register_completed"), true);
  assert.equal(summary.final_long_continuation_review2_open_blockers.includes("runtime_readiness_not_claimed"), true);
  assert.equal(summary.final_long_continuation_review2_rejections.includes("review2_executes_renderer"), true);
  assert.equal(summary.final_long_continuation_review2_rejections.includes("review2_claims_runtime_ready"), true);
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
function assertLive2dMotionIdentityComfortPublicSummary(summary) {
  assert.equal(summary.schema, LIVE2D_MOTION_IDENTITY_COMFORT_PUBLIC_SUMMARY_SCHEMA);
  assert.equal(summary.live2d_motion_identity_comfort_public_summary_status, "public_summary_blocked");
  assert.equal(summary.planning_only_boundary, true);
  assert.equal(summary.motion_identity_comfort_public_summary_only_boundary, true);
  assert.equal(summary.public_safe_labels_only_boundary, true);
  assert.equal(summary.no_owner_only_detail_boundary, true);
  assert.equal(summary.no_renderer_execution_boundary, true);
  assert.equal(summary.no_cue_application_boundary, true);
  assert.equal(summary.no_actual_data_boundary, true);
  assert.equal(summary.no_owner_confirmation_boundary, true);
  assert.equal(summary.no_readiness_claim_boundary, true);
  assert.equal(summary.motion_identity_comfort_public_summary_only, true);
  assert.equal(summary.public_safe_labels_only, true);
  assert.equal(summary.public_summary_reflects_network_locator_material, false);
  assert.equal(summary.public_summary_reflects_auth_material, false);
  assert.equal(summary.public_summary_reflects_renderer_material, false);
  assert.equal(summary.public_summary_reflects_cue_material, false);
  assert.equal(summary.public_summary_reflects_model_locator_material, false);
  assert.equal(summary.public_summary_reflects_motion_locator_material, false);
  assert.equal(summary.public_summary_reflects_owner_only_detail, false);
  assert.equal(summary.public_summary_reflects_private_relation_signal, false);
  assert.equal(summary.public_summary_reflects_private_support_signal, false);
  assert.equal(summary.public_summary_reflects_dependency_note_material, false);
  assert.equal(summary.public_summary_claims_runtime_ready, false);
  assert.equal(summary.public_summary_claims_production_ready, false);
  assert.equal(summary.runtime_readiness_claimed, false);
  assert.equal(summary.production_readiness_claimed, false);
  assert.equal(summary.renderer_ready_claimed, false);
  assert.equal(summary.renderer_ready_candidate, false);
  ...
  assert.equal(summary.motion_dataset_executable, false);
  assert.equal(summary.priority1_status, "BLOCKED");
  assert.deepEqual(summary.public_summary_sections, [...LIVE2D_MOTION_IDENTITY_COMFORT_PUBLIC_SUMMARY_SECTIONS]);
  assert.deepEqual(summary.public_summary_allowed_labels, [...LIVE2D_MOTION_IDENTITY_COMFORT_PUBLIC_SUMMARY_ALLOWED_LABELS]);
  assert.deepEqual(summary.public_summary_rejections, [...LIVE2D_MOTION_IDENTITY_COMFORT_PUBLIC_SUMMARY_REJECTIONS]);
  assert.equal(summary.public_summary_section_count, LIVE2D_MOTION_IDENTITY_COMFORT_PUBLIC_SUMMARY_SECTIONS.length);
  assert.equal(summary.public_summary_allowed_label_count, LIVE2D_MOTION_IDENTITY_COMFORT_PUBLIC_SUMMARY_ALLOWED_LABELS.length);
  assert.equal(summary.public_summary_rejection_count, LIVE2D_MOTION_IDENTITY_COMFORT_PUBLIC_SUMMARY_REJECTIONS.length);
  for (const blocker of [
  ...
  assert.equal(summary.public_summary_sections.includes("identity_profile_status"), true);
  assert.equal(summary.public_summary_allowed_labels.includes("public_safe_labels_only"), true);
  assert.equal(summary.public_summary_rejections.includes("public_summary_reflects_owner_only_detail"), true);
  assert.equal(summary.public_summary_rejections.includes("public_summary_claims_runtime_ready"), true);
  assert.equal(summary.boundary_policy.no_motion_execution, true);
  assert.equal(summary.boundary_policy.no_real_row_ingestion, true);
  assert.equal(summary.boundary_policy.no_runtime_readiness_claim, true);
  assert.equal(summary.boundary_policy.no_production_readiness_claim, true);
...
{
  const summary = createLive2dMotionIdentityAndComfortSpecSummary({
    motion_allowlist_alone_is_executable_readiness: true,
    experimental_labels_are_executable_motion: true,
    expression_gaze_breath_body_camera_labels_are_runtime_motion: true,
  ...
  assertLive2dMotionIdentityAndComfortSpec(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_and_comfort_spec_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityAndComfortRejectionFixturePackSummary({
    motion_allowlist_alone_is_executable_readiness: true,
    experimental_labels_are_executable_motion: true,
    strong_motion_without_recovery_allowed: true,
    strong_motion_without_cooldown_allowed: true,
    stale_cue_strong_motion_allowed: true,
    comfort_risk_strong_motion_allowed: true,
    subtitle_overlay_risk_strong_motion_allowed: true,
    gaze_pressure_closeup_escalation_allowed: true,
    donation_relation_dependency_escalation_allowed: true,
    dependency_pressure_allowed: true,
    voice_motion_sync_executes_motion: true,
    adaptive_reaction_unbounded: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    motion_dataset_executable: true,
    trusted_loader_allowlist_enabled: true,
    ...
    runtime_readiness_claimed: true,
    production_readiness_claimed: true,
    raw_renderer_payload: "raw_renderer_payload",
  });
  assertLive2dMotionIdentityAndComfortRejectionFixturePack(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_and_comfort_rejection_fixture_pack_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityAndComfortDryRunValidatorSummary({
    dry_run_validator_executes_motion: true,
    dry_run_validator_accepts_actual_data: true,
    strong_motion_without_recovery_allowed: true,
    strong_motion_without_cooldown_allowed: true,
    stale_cue_strong_motion_allowed: true,
    risky_strong_motion_allowed: true,
    donation_relation_dependency_escalation_allowed: true,
    dependency_pressure_allowed: true,
    voice_motion_sync_executes_motion: true,
    adaptive_reaction_unbounded: true,
  ...
  assertLive2dMotionIdentityAndComfortDryRunValidator(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_and_comfort_dry_run_validator_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityAndComfortRecoveryMatrixSummary({
    recovery_matrix_executes_motion: true,
    recovery_matrix_claims_runtime_ready: true,
    strong_motion_without_recovery_allowed: true,
    strong_motion_without_cooldown_allowed: true,
    stale_cue_strong_motion_allowed: true,
    risky_strong_motion_allowed: true,
  ...
  assertLive2dMotionIdentityAndComfortRecoveryMatrix(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_and_comfort_recovery_matrix_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityAndComfortContextGateSummary({
    context_gate_executes_motion: true,
    context_gate_claims_runtime_ready: true,
    stale_context_strong_motion_allowed: true,
    low_confidence_strong_motion_allowed: true,
    viewer_comfort_risk_strong_motion_allowed: true,
    subtitle_visibility_risk_strong_motion_allowed: true,
    camera_proximity_risk_strong_motion_allowed: true,
    donation_relation_dependency_only_escalation_allowed: true,
    dependency_pressure_allowed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    motion_dataset_executable: true,
  ...
  assertLive2dMotionIdentityAndComfortContextGate(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_and_comfort_context_gate_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityAndComfortSubtitleGazeGuardSummary({
    subtitle_gaze_guard_executes_motion: true,
    subtitle_gaze_guard_claims_runtime_ready: true,
    subtitle_overlay_risk_strong_motion_allowed: true,
    subtitle_overlay_risk_closeup_allowed: true,
    gaze_pressure_risk_strong_motion_allowed: true,
    gaze_pressure_risk_closeup_allowed: true,
    camera_proximity_risk_strong_motion_allowed: true,
    camera_proximity_risk_closeup_allowed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    motion_dataset_executable: true,
    trusted_loader_allowlist_enabled: true,
  ...
  assertLive2dMotionIdentityAndComfortSubtitleGazeGuard(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_and_comfort_subtitle_gaze_guard_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityAndComfortPersonaPressureGuardSummary({
    persona_pressure_guard_executes_motion: true,
    persona_pressure_guard_claims_runtime_ready: true,
    donation_signal_escalates_strong_motion_allowed: true,
    relation_signal_escalates_strong_motion_allowed: true,
    dependency_signal_escalates_strong_motion_allowed: true,
    dependency_pressure_allowed: true,
    persona_fit_claims_relationship_commitment_allowed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    motion_dataset_executable: true,
    trusted_loader_allowlist_enabled: true,
  ...
  assertLive2dMotionIdentityAndComfortPersonaPressureGuard(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_and_comfort_persona_pressure_guard_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityAndComfortVoiceSyncHintBoundarySummary({
    voice_sync_hint_executes_motion: true,
    voice_timing_hint_applies_cue: true,
    voice_sync_hint_claims_runtime_ready: true,
    audio_runtime_execution_allowed: true,
    tts_runtime_execution_allowed: true,
  ...
  assertLive2dMotionIdentityAndComfortVoiceSyncHintBoundary(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_and_comfort_voice_sync_hint_boundary_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityAndComfortAdaptiveBoundsSummary({
    adaptive_bounds_executes_motion: true,
    adaptive_bounds_claims_runtime_ready: true,
    adaptive_reaction_unbounded: true,
    repeated_strong_motion_allowed: true,
    low_confidence_escalation_allowed: true,
    stale_context_escalation_allowed: true,
    comfort_risk_escalation_allowed: true,
    serious_focus_playful_motion_allowed: true,
    moderation_limited_personalized_strong_motion_allowed: true,
    crisis_signal_closeup_allowed: true,
    minor_signal_closeup_allowed: true,
    romantic_pressure_closeup_allowed: true,
    dependency_pressure_strong_motion_allowed: true,
    donation_amount_escalates_motion_allowed: true,
    relationship_score_escalates_proximity_allowed: true,
    experimental_motion_labels_executable: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    motion_dataset_executable: true,
    trusted_loader_allowlist_enabled: true,
  ...
  assertLive2dMotionIdentityAndComfortAdaptiveBounds(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_and_comfort_adaptive_bounds_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityComfortDevelopmentScheduleSummary({
    schedule_executes_motion: true,
    schedule_claims_runtime_ready: true,
    schedule_claims_production_ready: true,
    schedule_creates_owner_confirmation: true,
    future_real_renderer_evidence_phase_started: true,
    future_actual_renderer_probe_phase_started: true,
    future_trusted_loader_phase_started: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    motion_dataset_executable: true,
    trusted_loader_allowlist_enabled: true,
  ...
  assertLive2dMotionIdentityComfortDevelopmentSchedule(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_comfort_development_schedule_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityComfortCompletionReviewSummary({
    completion_review_claims_runtime_ready: true,
    completion_review_claims_production_ready: true,
    completion_review_creates_owner_confirmation: true,
    completion_review_starts_actual_renderer_probe: true,
    completion_review_accepts_actual_data: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    owner_confirmation_confirmed: true,
    priority1_resolved: true,
  ...
  assertLive2dMotionIdentityComfortCompletionReview(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_comfort_completion_review_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityProfileStatusSurfaceSummary({
    identity_profile_executes_motion: true,
    identity_profile_claims_runtime_ready: true,
    identity_profile_claims_production_ready: true,
    experimental_labels_executable: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    owner_confirmation_confirmed: true,
    motion_dataset_executable: true,
  ...
  assertLive2dMotionIdentityProfileStatusSurface(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_profile_status_surface_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionComfortPolicyStatusSurfaceSummary({
    comfort_policy_executes_motion: true,
    comfort_policy_marks_strong_motion_ready: true,
    viewer_comfort_mode_downgrades_strong_motion: false,
    cooldown_required_for_strong_motion: false,
    fatigue_risk_downgrades_strong_motion: false,
    photosensitivity_risk_downgrades_strong_motion: false,
    subtitle_gaze_camera_risk_downgrades_strong_motion: false,
    renderer_ready_candidate: true,
    renderer_ready: true,
    owner_confirmation_confirmed: true,
    motion_dataset_executable: true,
  ...
  assertLive2dMotionComfortPolicyStatusSurface(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_comfort_policy_status_surface_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionFreshnessPolicyCrossSurfaceConsistencySummary({
    stale_cue_strong_motion_rejected_across_surfaces: false,
    safe_downgrade_same_meaning_across_surfaces: false,
    freshness_policy_executes_motion: true,
    freshness_policy_applies_cue: true,
    freshness_policy_claims_runtime_ready: true,
    freshness_policy_claims_production_ready: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    owner_confirmation_confirmed: true,
    motion_dataset_executable: true,
  ...
  assertLive2dMotionFreshnessPolicyCrossSurfaceConsistency(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_freshness_policy_cross_surface_consistency_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionStrongMotionUnsafeOverrideRejectionSummary({
    surprise_scream_executable: true,
    happy_dance_executable: true,
    laugh_big_recovery_required: false,
    happy_loud_sing_cooldown_required: false,
    strong_motion_ready: true,
    strong_motion_downgraded_or_rejected: false,
...
{
  const summary = createLive2dMotionIdentityComfortNoSweeteningSweepSummary({
    spec_completion_is_runtime_readiness: true,
    fixture_pass_is_runtime_readiness: true,
    dry_run_pass_is_runtime_readiness: true,
    schedule_update_is_runtime_readiness: true,
    completion_review_is_runtime_readiness: true,
    status_surface_executes_motion: true,
    experimental_labels_executable: true,
    runtime_motion_executable: true,
    strong_motion_ready: true,
    renderer_ready_claimed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
  ...
  assertLive2dMotionIdentityComfortNoSweeteningSweep(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_comfort_no_sweetening_sweep_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityComfortImplementationGapAuditSummary({
    gap_audit_executes_renderer: true,
    gap_audit_applies_cue: true,
    gap_audit_loads_model: true,
    gap_audit_loads_scene: true,
    gap_audit_claims_runtime_ready: true,
    gap_audit_claims_production_ready: true,
    renderer_ready_claimed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    owner_confirmation_confirmed: true,
  ...
  assertLive2dMotionIdentityComfortImplementationGapAudit(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_comfort_implementation_gap_audit_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityComfortImplementationGapRegisterSummary({
    gap_register_executes_renderer: true,
    gap_register_applies_cue: true,
    gap_register_loads_model: true,
    gap_register_loads_scene: true,
    gap_register_claims_runtime_ready: true,
    gap_register_claims_production_ready: true,
    renderer_ready_claimed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    owner_confirmation_confirmed: true,
  ...
  assertLive2dMotionIdentityComfortImplementationGapRegister(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_comfort_implementation_gap_register_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityComfortFinalLongContinuationReview2Summary({
    review2_executes_renderer: true,
    review2_applies_cue: true,
    review2_loads_model: true,
    review2_loads_scene: true,
    review2_claims_runtime_ready: true,
    review2_claims_production_ready: true,
    renderer_ready_claimed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    owner_confirmation_confirmed: true,
  ...
  assertLive2dMotionIdentityComfortFinalLongContinuationReview2(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_comfort_final_long_continuation_review2_rejected_state_promotion"), true);
}

{
  const summary = createLive2dMotionIdentityComfortPublicSummary({
    public_summary_reflects_network_locator_material: true,
    public_summary_reflects_auth_material: true,
    public_summary_reflects_renderer_material: true,
    public_summary_reflects_cue_material: true,
    public_summary_reflects_model_locator_material: true,
    public_summary_reflects_motion_locator_material: true,
    public_summary_reflects_owner_only_detail: true,
    public_summary_reflects_private_relation_signal: true,
    public_summary_reflects_private_support_signal: true,
    public_summary_reflects_dependency_note_material: true,
    public_summary_claims_runtime_ready: true,
    public_summary_claims_production_ready: true,
    renderer_ready_claimed: true,
    renderer_ready_candidate: true,
    renderer_ready: true,
    owner_confirmation_confirmed: true,
  ...
  assertLive2dMotionIdentityComfortPublicSummary(summary);
  assert.equal(summary.blocked_reasons.includes("live2d_motion_identity_comfort_public_summary_rejected_state_promotion"), true);
}
...
{
  const summary = createRendererReadyOwnerEvidenceHandoffPacketStubSummary();
  assertRendererReadyOwnerEvidenceHandoffPacketStub(summary);
  assert.equal(summary.requiredStubItems.includes("required_owner_confirmation_label"), true);
  assert.equal(summary.handoffPacketSent, false);
}

{
  const summary = createRendererReadyOwnerHandoffNotSentGuardSummary();
...
{
  const summary = createRendererReadyRealProbeRequestStubSummary();
  assertRendererReadyRealProbeRequestStub(summary);
  assert.equal(summary.rendererProbeRequested, false);
  assert.equal(summary.rendererProbeExecuted, false);
}

{
  const summary = createRendererReadyRealProbeRequestRejectionGateSummary();
  assertRendererReadyRealProbeRequestRejectionGate(summary);
  assert.equal(summary.rejectionReasons.includes("owner_confirmation_missing"), true);
  assert.equal(summary.rejectionReasons.includes("actual_probe_not_allowed_in_this_task"), true);
}

{
  const summary = createRendererReadyRealProbePreflightBlockerMatrixSummary();
  assertRendererReadyRealProbePreflightBlockerMatrix(summary);
  assert.equal(summary.blockers.includes("fresh_heartbeat_missing"), true);
  assert.equal(summary.probeAllowed, false);
}

{
  const summary = createRendererReadyEvidenceCollectorManifestStubSummary();
...
{
  const summary = createRendererReadyEvidenceCollectorSafeOutputSchemaSummary();
...
{
  const summary = createRendererReadyPublicSummaryRedactionSummary();
  assertRendererReadyPublicSummaryRedaction(summary);
  assert.equal(summary.publicSummaryRedactionStatus, "safe_labels_counts_status_only");
  assert.equal(summary.ownerOnlyDetailPresent, false);
}

{
  const summary = createRendererReadyAdminSummaryRedactionSummary();
...
{
  const summary = createRendererReadyFinalPreOwnerBlockerSummary();
  assertRendererReadyFinalPreOwnerBlockerSummary(summary);
  assert.equal(summary.remainingBlockers.includes("owner_confirmation_missing"), true);
  assert.equal(summary.runtimeReadinessClaimed, false);
}

{
  const summary = createRendererReadyLongContinuationCompletionReview2Summary();
...
{
  const summary = createRendererReadyPreOwnerWaitState2Summary();
  assertRendererReadyPreOwnerWaitState2(summary);
  assert.equal(summary.ownerConfirmationCreated, false);
  assert.equal(summary.ownerHandoffSent, false);
}

{
  const summary = createRendererReadyAuditReferenceStubSummary();
  assertRendererReadyAuditReferenceStub(summary);
  assert.equal(summary.rendererReadinessAuditReferenceRequired, true);
  assert.equal(summary.rendererReadinessAuditReferencePresent, false);
}

{
  const summary = createRendererReadyAuditReferenceMissingGuardSummary();
  assertRendererReadyAuditReferenceMissingGuard(summary);
  assert.equal(summary.auditReferenceMissing, true);
  assert.equal(summary.rendererReadyCandidate, false);
}

{
  const summary = createRendererReadySafeOperatorChecklistStubSummary();
  assertRendererReadySafeOperatorChecklistStub(summary);
  assert.equal(summary.operatorChecklistExecuted, false);
  assert.equal(summary.safeChecklistItems.includes("keep_trusted_loader_disabled"), true);
}

{
  const summary = createRendererReadySafeOperatorChecklistRedactionGuardSummary();
  assertRendererReadySafeOperatorChecklistRedactionGuard(summary);
  assert.equal(summary.sourceValueEchoed, false);
  assert.equal(summary.operatorChecklistExecuted, false);
}

{
  const summary = createRendererReadyRealEvidenceRequestFinalNoGoSummary();
  assertRendererReadyRealEvidenceRequestFinalNoGo(summary);
  assert.equal(summary.realEvidenceRequestSent, false);
  assert.equal(summary.realEvidenceCollectionStarted, false);
}

{
  const summary = createRendererReadyPreflightRouteManifestStubSummary();
  assertRendererReadyPreflightRouteManifestStub(summary);
  assert.equal(summary.preflightRouteExecuted, false);
  assert.equal(summary.realPreflightStarted, false);
}

{
  const summary = createRendererReadyPreflightRouteUnsafeFieldGuardSummary();
  assertRendererReadyPreflightRouteUnsafeFieldGuard(summary);
  assert.equal(summary.sourceValueEchoed, false);
  assert.equal(summary.preflightRouteExecuted, false);
}

{
  const summary = createRendererReadyOwnerScopeRequirementSurfaceSummary();
  assertRendererReadyOwnerScopeRequirementSurface(summary);
  assert.equal(summary.ownerScopeConfirmed, false);
  assert.equal(summary.probeAllowed, false);
}

{
  const summary = createRendererReadyOwnerScopeMissingRejectionGuardSummary();
  assertRendererReadyOwnerScopeMissingRejectionGuard(summary);
  assert.equal(summary.probeRequestRejected, true);
  assert.equal(summary.readinessRequestRejected, true);
}

{
  const summary = createRendererReadyAuditLinkRequirementSurfaceSummary();
...
{
  const summary = createRendererReadyTrustedLoaderPreauthBlockerSurfaceSummary();
  assertRendererReadyTrustedLoaderPreauthBlockerSurface(summary);
  assert.equal(summary.trustedLoaderPreauthStatus, "blocked");
  assert.equal(summary.trustedLoaderAllowlistEnabled, false);
}

{
  const summary = createRendererReadyTrustedLoaderPreauthRejectionGuardSummary();
  assertRendererReadyTrustedLoaderPreauthRejectionGuard(summary);
  assert.equal(summary.trustedLoaderEnablementRejected, true);
  assert.equal(summary.trustedLoaderAllowlistEnabled, false);
}

{
  const summary = createRendererReadyRuntimeReadinessFinalNoGoSummary();
...
{
  const summary = createRendererReadyExtendedGuardCompletionReviewSummary();
  assertRendererReadyExtendedGuardCompletionReview(summary);
  assert.equal(summary.completionReviewOnly, true);
  assert.equal(summary.stopAfterReview, false);
}

{
  const summary = createRendererReadyRealEvidenceRequestFinalWaitStateSummary();
