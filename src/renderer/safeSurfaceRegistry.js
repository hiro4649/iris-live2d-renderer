...
export const SAFE_SURFACE_REGISTRY = Object.freeze([
  Object.freeze({
    ...
    surfaceKeys: ["schema", "renderer_ready", "renderer_health", "boundary_policy"],
    surfaces: ["GET /status"],
  ...
  Object.freeze({
    ...
    surfaceKeys: ["schema", "renderer_ready", "live2d_evidence_summary", "boundary_policy"],
    surfaces: ["GET /health"],
    ...SAFE_SURFACE_EFFECTS,
    compatibilityAlias: [],
    deprecatedBy: null,
  ...
  Object.freeze({
    ...
    surfaceKeys: ["schema", "model3", "live2d_evidence_summary"],
